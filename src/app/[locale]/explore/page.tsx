...
const EXPLORE_TEXT = {
  de: {
    searchPlaceholder:"QR-X suchen",all:"Alle",visible:"sichtbar",topFirst:"Top zuerst",chooseView:"Wähle, welche QR-X du sehen möchtest",justCreated:"Gerade erstellt",resultTabs:"Explore Ergebnis-Tabs",currentSelected:"QR-X aktuell ausgewählt",selected:"QR-X ausgewählt",selectMarker:"Wähle einen Marker, um den passenden Eintrag hier hervorzuheben.",
  ...
  en: {
    searchPlaceholder:"Search QR-X",all:"All",visible:"visible",topFirst:"Top first",chooseView:"Choose which QR-X you want to see",justCreated:"Just created",resultTabs:"Explore result tabs",currentSelected:"QR-X currently selected",selected:"QR-X selected",selectMarker:"Select a marker to highlight the matching entry here.",
  ...
  tr: {
    searchPlaceholder:"QR-X ara",all:"Tümü",visible:"görünür",topFirst:"En iyiler önce",chooseView:"Hangi QR-X’leri görmek istediğini seç",justCreated:"Yeni oluşturuldu",resultTabs:"Explore sonuç sekmeleri",currentSelected:"Şu anda seçili QR-X",selected:"QR-X seçildi",selectMarker:"İlgili kaydı burada vurgulamak için bir işaretçi seç.",
  ...
  pl: {
    searchPlaceholder:"Szukaj QR-X",all:"Wszystkie",visible:"widoczne",topFirst:"Najlepsze najpierw",chooseView:"Wybierz, które QR-X chcesz zobaczyć",justCreated:"Utworzone niedawno",resultTabs:"Karty wyników Explore",currentSelected:"Aktualnie wybrany QR-X",selected:"Wybrany QR-X",selectMarker:"Wybierz znacznik, aby wyróżnić tutaj odpowiedni wpis.",
  ...
  ar: {
    searchPlaceholder:"ابحث عن QR-X",all:"الكل",visible:"ظاهر",topFirst:"الأفضل أولاً",chooseView:"اختر QR-X التي تريد رؤيتها",justCreated:"أُنشئ للتو",resultTabs:"علامات تبويب نتائج Explore",currentSelected:"QR-X المحدد حاليًا",selected:"تم تحديد QR-X",selectMarker:"اختر علامة لإبراز الإدخال المطابق هنا.",
  ...
  fr: {
    searchPlaceholder:"Rechercher un QR-X",all:"Tous",visible:"visibles",topFirst:"Meilleurs d’abord",chooseView:"Choisissez les QR-X que vous souhaitez voir",justCreated:"Créé récemment",resultTabs:"Onglets des résultats Explore",currentSelected:"QR-X actuellement sélectionné",selected:"QR-X sélectionné",selectMarker:"Sélectionnez un marqueur pour mettre en évidence l’entrée correspondante ici.",
  ...
  es: {
    searchPlaceholder:"Buscar QR-X",all:"Todos",visible:"visibles",topFirst:"Mejores primero",chooseView:"Elige qué QR-X quieres ver",justCreated:"Recién creado",resultTabs:"Pestañas de resultados de Explore",currentSelected:"QR-X seleccionado actualmente",selected:"QR-X seleccionado",selectMarker:"Selecciona un marcador para destacar aquí la entrada correspondiente.",
  ...
  it: {
    searchPlaceholder:"Cerca QR-X",all:"Tutti",visible:"visibili",topFirst:"I migliori prima",chooseView:"Scegli quali QR-X vuoi vedere",justCreated:"Appena creati",resultTabs:"Schede dei risultati Explore",currentSelected:"QR-X attualmente selezionato",selected:"QR-X selezionato",selectMarker:"Seleziona un marker per evidenziare qui la voce corrispondente.",
  ...
  "linear-gradient(180deg, rgba(13, 23, 38, 0) 0%, rgba(13, 23, 38, 0.45) 52%, rgba(13, 23, 38, 0.72) 100%)",
      ...
      >
        ...
        <div id="explore-hub" className="mioseg-explore-hub">
          ...
          <div className="mioseg-explore-tabs" aria-label={ui.resultTabs}>
          ...
          >
            <div className={styles.compareLabelFeatured}>{ui.currentSelected}</div>
            <h3 id="activeMapQrxTitle" className={styles.compareTitleFeatured}>{ui.selected}</h3>
