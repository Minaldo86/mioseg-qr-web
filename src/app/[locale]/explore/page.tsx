...
const EXPLORE_TEXT = {
  de: {
    searchPlaceholder:"QR-X suchen",
    all:"Alle",
    visible:"sichtbar",
    topFirst:"Top zuerst",
    chooseQrx:"Wähle, welche QR-X du sehen möchtest",
  ...
  en: {
    searchPlaceholder:"Search QR-X",
    all:"All",
    visible:"visible",
    topFirst:"Top first",
    chooseQrx:"Choose which QR-X you want to see",
  ...
  tr: {
    searchPlaceholder:"QR-X ara",
    all:"Tümü",
    visible:"görünür",
    topFirst:"En iyiler önce",
    chooseQrx:"Hangi QR-X'leri görmek istediğini seç",
  ...
  pl: {
    searchPlaceholder:"Szukaj QR-X",
    all:"Wszystkie",
    visible:"widoczne",
    topFirst:"Najlepsze najpierw",
    chooseQrx:"Wybierz, które QR-X chcesz zobaczyć",
  ...
  ar: {
    searchPlaceholder:"ابحث عن QR-X",
    all:"الكل",
    visible:"ظاهر",
    topFirst:"الأفضل أولًا",
    chooseQrx:"اختر عناصر QR-X التي تريد رؤيتها",
  ...
  fr: {
    searchPlaceholder:"Rechercher un QR-X",
    all:"Tous",
    visible:"visibles",
    topFirst:"Les meilleurs d'abord",
    chooseQrx:"Choisissez les QR-X que vous souhaitez voir",
  ...
  es: {
    searchPlaceholder:"Buscar QR-X",
    all:"Todos",
    visible:"visibles",
    topFirst:"Mejores primero",
    chooseQrx:"Elige qué QR-X quieres ver",
  ...
  it: {
    searchPlaceholder:"Cerca QR-X",
    all:"Tutti",
    visible:"visibili",
    topFirst:"I migliori prima",
    chooseQrx:"Scegli quali QR-X vuoi vedere",
