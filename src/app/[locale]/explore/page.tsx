...
const EXPLORE_TEXT = {
  de: {
    searchPlaceholder:"Mioseg QR suchen",
    all:"Alle",
    visible:"sichtbar",
    topFirst:"Top zuerst",
    chooseQrx:"Wähle, welche Mioseg QR du sehen möchtest",
    justCreated:"Gerade erstellt",
    tabsAria:"Explore Ergebnis-Tabs",
    home:"Startseite",dashboard:"Dashboard",account:"Konto",heroTitle:"Entdecke Business Mioseg QR in deiner Nähe",heroText:"Finde Restaurants, Praxen, Unternehmen, Dienstleistungen und besondere Orte auf einer modernen öffentlichen Karte. Jeder Eintrag führt direkt zur passenden Mioseg QR Webansicht.",viewEntries:"Einträge ansehen",openMap:"Karte öffnen",totalBusiness:"Business Mioseg QR insgesamt",visibleHits:"sichtbare Treffer",activeCategories:"aktive Kategorien",verifiedProfiles:"verifizierte Profile",totalFollowers:"Follower insgesamt",totalViews:"Aufrufe insgesamt",publicMap:"Öffentliche Business-Karte",publicMapText:"Suche, filtere und öffne öffentliche Business Mioseg QR direkt auf der Karte. Entdecke neue Orte, Unternehmen und Angebote in deiner Umgebung.",search:"Suche",map:"Karte",verified:"Verifiziert",openQrx:"Mioseg QR öffnen →",results:"Ergebnisse",mapLive:"Suche, bewege und entdecke Mioseg QR live",qrxMap:"Mioseg QR Karte",qrxMapText:"Suche echte Mioseg QR, springe zu deinem Standort oder bewege die Karte – die Ergebnisse darunter reagieren live auf den Kartenausschnitt.",noMatches:"Keine passenden Mioseg QR gefunden.",startSearch:"Suche starten",nearMe:"In meiner Nähe",locationActive:"Standort aktiv",reset:"Zurücksetzen",withLocation:"mit Standort",mapUpdating:"Karte wird aktualisiert …",currentResults:"Ergebnisse im aktuellen Kartenausschnitt",defaultRanking:"Standardmäßig zeigen wir die beliebtesten Einträge. Du kannst jederzeit auf Nähe oder neue Mioseg QR wechseln.",locationOptional:"Standort optional",currentMapArea:"Aktueller Kartenausschnitt",allVisible:"Alle sichtbaren Mioseg QR",popular:"Beliebt",rankingArea:"Ranking im Kartenausschnitt",distanceSorted:"Nach Entfernung sortiert",activateLocation:"Standort aktivieren",newLabel:"Neu",noVisible:"Keine Mioseg QR im sichtbaren Bereich",noVisibleText:"Verschiebe die Karte oder zoome heraus, um wieder Business Mioseg QR im aktuellen Kartenausschnitt zu sehen.",popularArea:"Beliebt im Kartenausschnitt",noPopular:"Keine beliebten Mioseg QR gefunden",moveOrFilter:"Verschiebe die Karte oder ändere deine Filter.",nearbyText:"Nach Entfernung zu deinem Standort sortiert.",nearbyNoLocation:"Aktiviere deinen Standort, um Mioseg QR in deiner Nähe zu sehen.",activateLocationHint:"Klicke auf „In meiner Nähe“, damit die nächsten Business Mioseg QR direkt hier angezeigt werden.",newArea:"Neu im Kartenausschnitt",newestArea:"Die neuesten Business Mioseg QR im aktuellen Kartenbereich.",errorState:"Fehlerzustand",loadError:"Fehler beim Laden",loadErrorText:"Die Explore-Einträge konnten gerade nicht geladen werden. Technische Meldung:",noNew:"Keine neuen Mioseg QR gefunden",untitled:"Unbenannter Mioseg QR",businessFallback:"Business Mioseg QR auf mioseg qr",other:"Sonstiges",away:"entfernt",follower:"Follower",followers:"Follower",view:"Aufruf",views:"Aufrufe",uniqueVisitors:"eindeutige Besucher",popularBadge:"🔥 Beliebt",strongInterest:"📈 Starkes Interesse",manyVisitors:"👀 Viele Besucher",trustProfile:"⭐ Vertrauensprofil",highDemand:"🚀 Sehr gefragt",newSince:"Neu seit",tapMarker:"Tippen zeigt Marker",noLocationData:"Ohne Standortdaten",mapSelected:"Gerade auf der Karte ausgewählt",selectedQrx:"📍 Ausgewählter Mioseg QR",topRank:"👑 Platz 1 im aktuellen Kartenausschnitt",more:"Mehr anzeigen",browserNoGeo:"Standort wird von diesem Browser nicht unterstützt.",geoFailed:"Standort konnte nicht abgerufen werden.",geoPermission:"Standort konnte nicht abgerufen werden. Bitte Standortfreigabe im Browser erlauben.",geoAllow:"Standort konnte nicht abgerufen werden. Bitte erlaube den Standortzugriff im Browser.",locationLoading:"Standort wird geladen ...",locationShort:"Standort ...",noNewArea:"Keine neuen Mioseg QR in diesem Kartenausschnitt",noNewAreaText:"Bewege die Karte oder zoome heraus, um neue Business Mioseg QR in einem anderen Bereich zu entdecken.",selectedSentence:"Dieser Mioseg QR ist gerade auf der Karte ausgewählt.",categories:{praxis_gesundheit:"Praxis & Gesundheit",gastronomie:"Gastronomie",unternehmen:"Unternehmen",dienstleistung:"Dienstleistung",handwerk:"Handwerk",event:"Event",verein:"Verein",wohltaetigkeit:"Wohltätigkeit",sehenswuerdigkeit:"Sehenswürdigkeit",sonstiges:"Sonstiges"}
  },
  en: {
    searchPlaceholder:"Search Mioseg QR",
    all:"All",
    visible:"visible",
    topFirst:"Top first",
    chooseQrx:"Choose which Mioseg QR you want to see",
    justCreated:"Recently created",
    tabsAria:"Explore result tabs",
    home:"Home",dashboard:"Dashboard",account:"Account",heroTitle:"Discover Business Mioseg QR near you",heroText:"Find restaurants, practices, companies, services and special places on a modern public map. Every entry leads directly to the matching Mioseg QR web view.",viewEntries:"View entries",openMap:"Open map",totalBusiness:"Business Mioseg QR total",visibleHits:"visible results",activeCategories:"active categories",verifiedProfiles:"verified profiles",totalFollowers:"followers total",totalViews:"views total",publicMap:"Public business map",publicMapText:"Search, filter and open public Business Mioseg QR directly on the map. Discover new places, companies and offers around you.",search:"Search",map:"Map",verified:"Verified",openQrx:"Open Mioseg QR →",results:"Results",mapLive:"Search, move and discover Mioseg QR live",qrxMap:"Mioseg QR Map",qrxMapText:"Search real Mioseg QR, jump to your location or move the map – the results below react live to the map area.",noMatches:"No matching Mioseg QR found.",startSearch:"Start search",nearMe:"Near me",locationActive:"Location active",reset:"Reset",withLocation:"with location",mapUpdating:"Map is updating …",currentResults:"Results in the current map area",defaultRanking:"By default we show the most popular entries. You can switch to nearby or new Mioseg QR at any time.",locationOptional:"Location optional",currentMapArea:"Current map area",allVisible:"All visible Mioseg QR",popular:"Popular",rankingArea:"Ranking in map area",distanceSorted:"Sorted by distance",activateLocation:"Enable location",newLabel:"New",noVisible:"No Mioseg QR in the visible area",noVisibleText:"Move the map or zoom out to see Business Mioseg QR in the current map area again.",popularArea:"Popular in map area",noPopular:"No popular Mioseg QR found",moveOrFilter:"Move the map or change your filters.",nearbyText:"Sorted by distance from your location.",nearbyNoLocation:"Enable your location to see Mioseg QR near you.",activateLocationHint:"Click “Near me” to show the nearest Business Mioseg QR here.",newArea:"New in map area",newestArea:"The newest Business Mioseg QR in the current map area.",errorState:"Error state",loadError:"Loading error",loadErrorText:"Explore entries could not be loaded right now. Technical message:",noNew:"No new Mioseg QR found",untitled:"Untitled Mioseg QR",businessFallback:"Business Mioseg QR on mioseg qr",other:"Other",away:"away",follower:"Follower",followers:"Followers",view:"view",views:"views",uniqueVisitors:"unique visitors",popularBadge:"🔥 Popular",strongInterest:"📈 Strong interest",manyVisitors:"👀 Many visitors",trustProfile:"⭐ Trusted profile",highDemand:"🚀 High demand",newSince:"New since",tapMarker:"Tap to show marker",noLocationData:"No location data",mapSelected:"Selected on the map",selectedQrx:"📍 Selected Mioseg QR",topRank:"👑 #1 in current map area",more:"Show more",browserNoGeo:"Location is not supported by this browser.",geoFailed:"Location could not be retrieved.",geoPermission:"Location could not be retrieved. Please allow location access in your browser.",geoAllow:"Location could not be retrieved. Please allow browser location access.",locationLoading:"Loading location ...",locationShort:"Location ...",noNewArea:"No new Mioseg QR in this map area",noNewAreaText:"Move the map or zoom out to discover new Business Mioseg QR in another area.",selectedSentence:"This Mioseg QR is currently selected on the map.",categories:{praxis_gesundheit:"Practice & Health",gastronomie:"Food & Dining",unternehmen:"Company",dienstleistung:"Services",handwerk:"Trades",event:"Event",verein:"Association",wohltaetigkeit:"Charity",sehenswuerdigkeit:"Attraction",sonstiges:"Other"}
  },
  tr: {
    searchPlaceholder:"Mioseg QR ara",
    all:"Tümü",
    visible:"görünür",
    topFirst:"En iyiler önce",
    chooseQrx:"Hangi Mioseg QR'leri görmek istediğini seç",
    justCreated:"Yeni oluşturuldu",
    tabsAria:"Explore sonuç sekmeleri",
    home:"Ana sayfa",dashboard:"Panel",account:"Hesap",heroTitle:"Yakınındaki Business Mioseg QR’leri keşfet",heroText:"Restoranları, sağlık merkezlerini, şirketleri, hizmetleri ve özel yerleri modern bir herkese açık haritada bul. Her kayıt ilgili Mioseg QR web görünümüne doğrudan gider.",viewEntries:"Kayıtları görüntüle",openMap:"Haritayı aç",totalBusiness:"Toplam Business Mioseg QR",visibleHits:"görünür sonuç",activeCategories:"aktif kategori",verifiedProfiles:"doğrulanmış profil",totalFollowers:"toplam takipçi",totalViews:"toplam görüntüleme",publicMap:"Herkese açık işletme haritası",publicMapText:"Herkese açık Business Mioseg QR’leri haritada ara, filtrele ve aç. Çevrendeki yeni yerleri, şirketleri ve fırsatları keşfet.",search:"Ara",map:"Harita",verified:"Doğrulandı",openQrx:"Mioseg QR'i aç →",results:"Sonuçlar",mapLive:"Mioseg QR’leri canlı ara, haritayı taşı ve keşfet",qrxMap:"Mioseg QR Haritası",qrxMapText:"Gerçek Mioseg QR’leri ara, konumuna git veya haritayı taşı – aşağıdaki sonuçlar harita alanına göre canlı güncellenir.",noMatches:"Eşleşen Mioseg QR bulunamadı.",startSearch:"Aramayı başlat",nearMe:"Yakınımda",locationActive:"Konum aktif",reset:"Sıfırla",withLocation:"konumlu",mapUpdating:"Harita güncelleniyor …",currentResults:"Geçerli harita alanındaki sonuçlar",defaultRanking:"Varsayılan olarak en popüler kayıtları gösteriyoruz. İstediğin zaman yakındakilere veya yeni Mioseg QR’lere geçebilirsin.",locationOptional:"Konum isteğe bağlı",currentMapArea:"Geçerli harita alanı",allVisible:"Tüm görünür Mioseg QR’ler",popular:"Popüler",rankingArea:"Harita alanı sıralaması",distanceSorted:"Mesafeye göre sıralı",activateLocation:"Konumu etkinleştir",newLabel:"Yeni",noVisible:"Görünür alanda Mioseg QR yok",noVisibleText:"Geçerli harita alanında Business Mioseg QR görmek için haritayı taşı veya uzaklaştır.",popularArea:"Harita alanında popüler",noPopular:"Popüler Mioseg QR bulunamadı",moveOrFilter:"Haritayı taşı veya filtrelerini değiştir.",nearbyText:"Konumuna olan mesafeye göre sıralı.",nearbyNoLocation:"Yakınındaki Mioseg QR’leri görmek için konumunu etkinleştir.",activateLocationHint:"En yakın Business Mioseg QR’leri burada göstermek için “Yakınımda” seçeneğine tıkla.",newArea:"Harita alanında yeni",newestArea:"Geçerli harita alanındaki en yeni Business Mioseg QR’ler.",errorState:"Hata durumu",loadError:"Yükleme hatası",loadErrorText:"Explore kayıtları şu anda yüklenemedi. Teknik mesaj:",noNew:"Yeni Mioseg QR bulunamadı",untitled:"Adsız Mioseg QR",businessFallback:"mioseg qr üzerinde Business Mioseg QR",other:"Diğer",away:"uzakta",follower:"Takipçi",followers:"Takipçi",view:"görüntüleme",views:"görüntüleme",uniqueVisitors:"benzersiz ziyaretçi",popularBadge:"🔥 Popüler",strongInterest:"📈 Yüksek ilgi",manyVisitors:"👀 Çok ziyaretçi",trustProfile:"⭐ Güvenilir profil",highDemand:"🚀 Çok talep görüyor",newSince:"Yeni",tapMarker:"İşaretçiyi göstermek için dokun",noLocationData:"Konum verisi yok",mapSelected:"Haritada seçili",selectedQrx:"📍 Seçili Mioseg QR",topRank:"👑 Geçerli harita alanında 1. sıra",more:"Daha fazla göster",browserNoGeo:"Bu tarayıcı konumu desteklemiyor.",geoFailed:"Konum alınamadı.",geoPermission:"Konum alınamadı. Lütfen tarayıcıda konum izni ver.",geoAllow:"Konum alınamadı. Lütfen tarayıcı konum erişimine izin ver.",locationLoading:"Konum yükleniyor ...",locationShort:"Konum ...",noNewArea:"Bu harita alanında yeni Mioseg QR yok",noNewAreaText:"Başka bir alandaki yeni Business Mioseg QR’leri keşfetmek için haritayı taşı veya uzaklaştır.",selectedSentence:"Bu Mioseg QR şu anda haritada seçili.",categories:{praxis_gesundheit:"Sağlık",gastronomie:"Gastronomi",unternehmen:"Şirket",dienstleistung:"Hizmet",handwerk:"Zanaat",event:"Etkinlik",verein:"Dernek",wohltaetigkeit:"Hayır kurumu",sehenswuerdigkeit:"Turistik yer",sonstiges:"Diğer"}
  },
  pl: {
    searchPlaceholder:"Szukaj Mioseg QR",
    all:"Wszystkie",
    visible:"widoczne",
    topFirst:"Najlepsze najpierw",
    chooseQrx:"Wybierz, które Mioseg QR chcesz zobaczyć",
    justCreated:"Ostatnio utworzone",
    tabsAria:"Karty wyników Explore",
    home:"Strona główna",dashboard:"Panel",account:"Konto",heroTitle:"Odkrywaj Business Mioseg QR w pobliżu",heroText:"Znajdź restauracje, gabinety, firmy, usługi i wyjątkowe miejsca na nowoczesnej publicznej mapie. Każdy wpis prowadzi bezpośrednio do odpowiedniego widoku Mioseg QR.",viewEntries:"Zobacz wpisy",openMap:"Otwórz mapę",totalBusiness:"Business Mioseg QR łącznie",visibleHits:"widoczne wyniki",activeCategories:"aktywne kategorie",verifiedProfiles:"zweryfikowane profile",totalFollowers:"obserwujący łącznie",totalViews:"wyświetlenia łącznie",publicMap:"Publiczna mapa firm",publicMapText:"Szukaj, filtruj i otwieraj publiczne Business Mioseg QR bezpośrednio na mapie. Odkrywaj nowe miejsca, firmy i oferty w okolicy.",search:"Szukaj",map:"Mapa",verified:"Zweryfikowano",openQrx:"Otwórz Mioseg QR →",results:"Wyniki",mapLive:"Szukaj, przesuwaj mapę i odkrywaj Mioseg QR na żywo",qrxMap:"Mapa Mioseg QR",qrxMapText:"Szukaj prawdziwych Mioseg QR, przejdź do swojej lokalizacji lub przesuwaj mapę – wyniki poniżej reagują na bieżący obszar mapy.",noMatches:"Nie znaleziono pasujących Mioseg QR.",startSearch:"Rozpocznij wyszukiwanie",nearMe:"W pobliżu",locationActive:"Lokalizacja aktywna",reset:"Resetuj",withLocation:"z lokalizacją",mapUpdating:"Mapa jest aktualizowana …",currentResults:"Wyniki w bieżącym obszarze mapy",defaultRanking:"Domyślnie pokazujemy najpopularniejsze wpisy. W każdej chwili możesz przełączyć się na pobliskie lub nowe Mioseg QR.",locationOptional:"Lokalizacja opcjonalna",currentMapArea:"Bieżący obszar mapy",allVisible:"Wszystkie widoczne Mioseg QR",popular:"Popularne",rankingArea:"Ranking w obszarze mapy",distanceSorted:"Sortowane według odległości",activateLocation:"Włącz lokalizację",newLabel:"Nowe",noVisible:"Brak Mioseg QR w widocznym obszarze",noVisibleText:"Przesuń mapę lub oddal widok, aby ponownie zobaczyć Business Mioseg QR.",popularArea:"Popularne w obszarze mapy",noPopular:"Nie znaleziono popularnych Mioseg QR",moveOrFilter:"Przesuń mapę lub zmień filtry.",nearbyText:"Sortowane według odległości od Twojej lokalizacji.",nearbyNoLocation:"Włącz lokalizację, aby zobaczyć Mioseg QR w pobliżu.",activateLocationHint:"Kliknij „W pobliżu”, aby wyświetlić tutaj najbliższe Business Mioseg QR.",newArea:"Nowe w obszarze mapy",newestArea:"Najnowsze Business Mioseg QR w bieżącym obszarze mapy.",errorState:"Stan błędu",loadError:"Błąd ładowania",loadErrorText:"Nie udało się teraz załadować wpisów Explore. Komunikat techniczny:",noNew:"Nie znaleziono nowych Mioseg QR",untitled:"Mioseg QR bez nazwy",businessFallback:"Business Mioseg QR w mioseg qr",other:"Inne",away:"od Ciebie",follower:"Obserwujący",followers:"Obserwujący",view:"wyświetlenie",views:"wyświetlenia",uniqueVisitors:"unikalni odwiedzający",popularBadge:"🔥 Popularne",strongInterest:"📈 Duże zainteresowanie",manyVisitors:"👀 Wielu odwiedzających",trustProfile:"⭐ Profil zaufany",highDemand:"🚀 Bardzo popularne",newSince:"Nowe od",tapMarker:"Dotknij, aby pokazać znacznik",noLocationData:"Brak danych lokalizacji",mapSelected:"Wybrane na mapie",selectedQrx:"📍 Wybrany Mioseg QR",topRank:"👑 1. miejsce w bieżącym obszarze mapy",more:"Pokaż więcej",browserNoGeo:"Ta przeglądarka nie obsługuje lokalizacji.",geoFailed:"Nie udało się pobrać lokalizacji.",geoPermission:"Nie udało się pobrać lokalizacji. Zezwól na dostęp do lokalizacji w przeglądarce.",geoAllow:"Nie udało się pobrać lokalizacji. Zezwól przeglądarce na dostęp do lokalizacji.",locationLoading:"Ładowanie lokalizacji ...",locationShort:"Lokalizacja ...",noNewArea:"Brak nowych Mioseg QR w tym obszarze mapy",noNewAreaText:"Przesuń mapę lub oddal widok, aby odkryć nowe Business Mioseg QR w innym obszarze.",selectedSentence:"Ten Mioseg QR jest obecnie wybrany na mapie.",categories:{praxis_gesundheit:"Zdrowie",gastronomie:"Gastronomia",unternehmen:"Firma",dienstleistung:"Usługi",handwerk:"Rzemiosło",event:"Wydarzenie",verein:"Stowarzyszenie",wohltaetigkeit:"Organizacja charytatywna",sehenswuerdigkeit:"Atrakcja",sonstiges:"Inne"}
  },
  ar: {
    searchPlaceholder:"ابحث عن Mioseg QR",
    all:"الكل",
    visible:"ظاهر",
    topFirst:"الأفضل أولًا",
    chooseQrx:"اختر عناصر Mioseg QR التي تريد رؤيتها",
    justCreated:"أُنشئ حديثًا",
    tabsAria:"علامات تبويب نتائج Explore",
    home:"الرئيسية",dashboard:"لوحة التحكم",account:"الحساب",heroTitle:"اكتشف Business Mioseg QR بالقرب منك",heroText:"اعثر على المطاعم والعيادات والشركات والخدمات والأماكن المميزة على خريطة عامة حديثة. كل إدخال يقود مباشرة إلى صفحة Mioseg QR المناسبة.",viewEntries:"عرض الإدخالات",openMap:"فتح الخريطة",totalBusiness:"إجمالي Business Mioseg QR",visibleHits:"نتائج ظاهرة",activeCategories:"فئات نشطة",verifiedProfiles:"ملفات موثقة",totalFollowers:"إجمالي المتابعين",totalViews:"إجمالي المشاهدات",publicMap:"خريطة الأعمال العامة",publicMapText:"ابحث عن Business Mioseg QR العامة وصفِّها وافتحها مباشرة على الخريطة. اكتشف أماكن وشركات وعروضًا جديدة حولك.",search:"بحث",map:"الخريطة",verified:"موثّق",openQrx:"فتح Mioseg QR ←",results:"النتائج",mapLive:"ابحث وحرّك الخريطة واكتشف Mioseg QR مباشرة",qrxMap:"خريطة Mioseg QR",qrxMapText:"ابحث عن Mioseg QR، انتقل إلى موقعك أو حرّك الخريطة – تتحدث النتائج أدناه مباشرة حسب نطاق الخريطة.",noMatches:"لم يتم العثور على Mioseg QR مطابق.",startSearch:"بدء البحث",nearMe:"بالقرب مني",locationActive:"الموقع مفعّل",reset:"إعادة تعيين",withLocation:"مع موقع",mapUpdating:"يتم تحديث الخريطة …",currentResults:"النتائج في نطاق الخريطة الحالي",defaultRanking:"نعرض افتراضيًا الإدخالات الأكثر شعبية. يمكنك التبديل في أي وقت إلى القريبة أو الجديدة.",locationOptional:"الموقع اختياري",currentMapArea:"نطاق الخريطة الحالي",allVisible:"كل Mioseg QR الظاهرة",popular:"شائع",rankingArea:"الترتيب في نطاق الخريطة",distanceSorted:"مرتبة حسب المسافة",activateLocation:"تفعيل الموقع",newLabel:"جديد",noVisible:"لا توجد Mioseg QR في النطاق الظاهر",noVisibleText:"حرّك الخريطة أو صغّرها لرؤية Business Mioseg QR في النطاق الحالي.",popularArea:"الأكثر شعبية في النطاق",noPopular:"لم يتم العثور على Mioseg QR شائعة",moveOrFilter:"حرّك الخريطة أو غيّر عوامل التصفية.",nearbyText:"مرتبة حسب المسافة من موقعك.",nearbyNoLocation:"فعّل موقعك لرؤية Mioseg QR القريبة منك.",activateLocationHint:"اضغط «بالقرب مني» لإظهار أقرب Business Mioseg QR هنا.",newArea:"جديد في نطاق الخريطة",newestArea:"أحدث Business Mioseg QR في نطاق الخريطة الحالي.",errorState:"حالة خطأ",loadError:"خطأ في التحميل",loadErrorText:"تعذر تحميل إدخالات Explore الآن. الرسالة التقنية:",noNew:"لم يتم العثور على Mioseg QR جديدة",untitled:"Mioseg QR بلا عنوان",businessFallback:"Business Mioseg QR على mioseg qr",other:"أخرى",away:"بعيدًا",follower:"متابع",followers:"متابعون",view:"مشاهدة",views:"مشاهدات",uniqueVisitors:"زوار فريدون",popularBadge:"🔥 شائع",strongInterest:"📈 اهتمام قوي",manyVisitors:"👀 زوار كثيرون",trustProfile:"⭐ ملف موثوق",highDemand:"🚀 مطلوب جدًا",newSince:"جديد منذ",tapMarker:"اضغط لإظهار العلامة",noLocationData:"لا توجد بيانات موقع",mapSelected:"محدد على الخريطة",selectedQrx:"📍 Mioseg QR محدد",topRank:"👑 المركز الأول في نطاق الخريطة الحالي",more:"عرض المزيد",browserNoGeo:"هذا المتصفح لا يدعم الموقع.",geoFailed:"تعذر الحصول على الموقع.",geoPermission:"تعذر الحصول على الموقع. يرجى السماح بالوصول إلى الموقع في المتصفح.",geoAllow:"تعذر الحصول على الموقع. يرجى السماح للمتصفح بالوصول إلى موقعك.",locationLoading:"جارٍ تحميل الموقع ...",locationShort:"الموقع ...",noNewArea:"لا توجد Mioseg QR جديدة في هذا النطاق",noNewAreaText:"حرّك الخريطة أو صغّرها لاكتشاف Business Mioseg QR جديدة في نطاق آخر.",selectedSentence:"هذا Mioseg QR محدد حاليًا على الخريطة.",categories:{praxis_gesundheit:"الصحة",gastronomie:"المطاعم",unternehmen:"شركة",dienstleistung:"خدمات",handwerk:"حِرف",event:"فعالية",verein:"جمعية",wohltaetigkeit:"أعمال خيرية",sehenswuerdigkeit:"معلم",sonstiges:"أخرى"}
  },
  fr: {
    searchPlaceholder:"Rechercher un Mioseg QR",
    all:"Tous",
    visible:"visibles",
    topFirst:"Les meilleurs d'abord",
    chooseQrx:"Choisissez les Mioseg QR que vous souhaitez voir",
    justCreated:"Créés récemment",
    tabsAria:"Onglets des résultats Explore",
    home:"Accueil",dashboard:"Tableau de bord",account:"Compte",heroTitle:"Découvrez les Business Mioseg QR près de vous",heroText:"Trouvez restaurants, cabinets, entreprises, services et lieux remarquables sur une carte publique moderne. Chaque entrée mène directement à la vue web Mioseg QR correspondante.",viewEntries:"Voir les entrées",openMap:"Ouvrir la carte",totalBusiness:"Total Business Mioseg QR",visibleHits:"résultats visibles",activeCategories:"catégories actives",verifiedProfiles:"profils vérifiés",totalFollowers:"abonnés au total",totalViews:"vues au total",publicMap:"Carte publique des entreprises",publicMapText:"Recherchez, filtrez et ouvrez des Business Mioseg QR publics directement sur la carte. Découvrez de nouveaux lieux, entreprises et offres autour de vous.",search:"Recherche",map:"Carte",verified:"Vérifié",openQrx:"Ouvrir le Mioseg QR →",results:"Résultats",mapLive:"Recherchez, déplacez la carte et découvrez les Mioseg QR en direct",qrxMap:"Carte Mioseg QR",qrxMapText:"Recherchez de vrais Mioseg QR, accédez à votre position ou déplacez la carte – les résultats ci-dessous réagissent en direct à la zone affichée.",noMatches:"Aucun Mioseg QR correspondant trouvé.",startSearch:"Lancer la recherche",nearMe:"Près de moi",locationActive:"Position active",reset:"Réinitialiser",withLocation:"avec position",mapUpdating:"Mise à jour de la carte …",currentResults:"Résultats dans la zone actuelle",defaultRanking:"Par défaut, nous affichons les entrées les plus populaires. Vous pouvez passer aux Mioseg QR proches ou nouveaux à tout moment.",locationOptional:"Position facultative",currentMapArea:"Zone actuelle de la carte",allVisible:"Tous les Mioseg QR visibles",popular:"Populaire",rankingArea:"Classement dans la zone",distanceSorted:"Trié par distance",activateLocation:"Activer la position",newLabel:"Nouveau",noVisible:"Aucun Mioseg QR dans la zone visible",noVisibleText:"Déplacez la carte ou dézoomez pour revoir les Business Mioseg QR dans la zone actuelle.",popularArea:"Populaires dans la zone",noPopular:"Aucun Mioseg QR populaire trouvé",moveOrFilter:"Déplacez la carte ou modifiez vos filtres.",nearbyText:"Triés selon la distance depuis votre position.",nearbyNoLocation:"Activez votre position pour voir les Mioseg QR proches.",activateLocationHint:"Cliquez sur « Près de moi » pour afficher ici les Business Mioseg QR les plus proches.",newArea:"Nouveaux dans la zone",newestArea:"Les Business Mioseg QR les plus récents dans la zone actuelle.",errorState:"État d’erreur",loadError:"Erreur de chargement",loadErrorText:"Les entrées Explore n’ont pas pu être chargées. Message technique :",noNew:"Aucun nouveau Mioseg QR trouvé",untitled:"Mioseg QR sans titre",businessFallback:"Business Mioseg QR sur mioseg qr",other:"Autre",away:"de distance",follower:"Abonné",followers:"Abonnés",view:"vue",views:"vues",uniqueVisitors:"visiteurs uniques",popularBadge:"🔥 Populaire",strongInterest:"📈 Fort intérêt",manyVisitors:"👀 Beaucoup de visiteurs",trustProfile:"⭐ Profil de confiance",highDemand:"🚀 Très demandé",newSince:"Nouveau depuis",tapMarker:"Touchez pour afficher le marqueur",noLocationData:"Aucune donnée de position",mapSelected:"Sélectionné sur la carte",selectedQrx:"📍 Mioseg QR sélectionné",topRank:"👑 N°1 dans la zone actuelle",more:"Afficher plus",browserNoGeo:"La localisation n’est pas prise en charge par ce navigateur.",geoFailed:"Impossible d’obtenir la position.",geoPermission:"Impossible d’obtenir la position. Veuillez autoriser l’accès à la localisation dans le navigateur.",geoAllow:"Impossible d’obtenir la position. Veuillez autoriser l’accès du navigateur à votre position.",locationLoading:"Chargement de la position ...",locationShort:"Position ...",noNewArea:"Aucun nouveau Mioseg QR dans cette zone",noNewAreaText:"Déplacez la carte ou dézoomez pour découvrir de nouveaux Business Mioseg QR ailleurs.",selectedSentence:"Ce Mioseg QR est actuellement sélectionné sur la carte.",categories:{praxis_gesundheit:"Santé",gastronomie:"Restauration",unternehmen:"Entreprise",dienstleistung:"Services",handwerk:"Artisanat",event:"Événement",verein:"Association",wohltaetigkeit:"Organisation caritative",sehenswuerdigkeit:"Site touristique",sonstiges:"Autre"}
  },
  es: {
    searchPlaceholder:"Buscar Mioseg QR",
    all:"Todos",
    visible:"visibles",
    topFirst:"Mejores primero",
    chooseQrx:"Elige qué Mioseg QR quieres ver",
    justCreated:"Creados recientemente",
    tabsAria:"Pestañas de resultados de Explore",
    home:"Inicio",dashboard:"Panel",account:"Cuenta",heroTitle:"Descubre Business Mioseg QR cerca de ti",heroText:"Encuentra restaurantes, consultas, empresas, servicios y lugares especiales en un mapa público moderno. Cada entrada lleva directamente a la vista web Mioseg QR correspondiente.",viewEntries:"Ver entradas",openMap:"Abrir mapa",totalBusiness:"Business Mioseg QR en total",visibleHits:"resultados visibles",activeCategories:"categorías activas",verifiedProfiles:"perfiles verificados",totalFollowers:"seguidores totales",totalViews:"visualizaciones totales",publicMap:"Mapa público de negocios",publicMapText:"Busca, filtra y abre Business Mioseg QR públicos directamente en el mapa. Descubre nuevos lugares, empresas y ofertas a tu alrededor.",search:"Buscar",map:"Mapa",verified:"Verificado",openQrx:"Abrir Mioseg QR →",results:"Resultados",mapLive:"Busca, mueve el mapa y descubre Mioseg QR en directo",qrxMap:"Mapa Mioseg QR",qrxMapText:"Busca Mioseg QR reales, ve a tu ubicación o mueve el mapa: los resultados inferiores reaccionan en directo al área mostrada.",noMatches:"No se encontraron Mioseg QR coincidentes.",startSearch:"Iniciar búsqueda",nearMe:"Cerca de mí",locationActive:"Ubicación activa",reset:"Restablecer",withLocation:"con ubicación",mapUpdating:"Actualizando el mapa …",currentResults:"Resultados en el área actual del mapa",defaultRanking:"De forma predeterminada mostramos las entradas más populares. Puedes cambiar a cercanas o nuevas en cualquier momento.",locationOptional:"Ubicación opcional",currentMapArea:"Área actual del mapa",allVisible:"Todos los Mioseg QR visibles",popular:"Popular",rankingArea:"Ranking en el área del mapa",distanceSorted:"Ordenado por distancia",activateLocation:"Activar ubicación",newLabel:"Nuevo",noVisible:"No hay Mioseg QR en el área visible",noVisibleText:"Mueve el mapa o aleja el zoom para volver a ver Business Mioseg QR en el área actual.",popularArea:"Popular en el área del mapa",noPopular:"No se encontraron Mioseg QR populares",moveOrFilter:"Mueve el mapa o cambia los filtros.",nearbyText:"Ordenados por distancia desde tu ubicación.",nearbyNoLocation:"Activa tu ubicación para ver Mioseg QR cercanos.",activateLocationHint:"Haz clic en «Cerca de mí» para mostrar aquí los Business Mioseg QR más próximos.",newArea:"Nuevos en el área del mapa",newestArea:"Los Business Mioseg QR más recientes del área actual.",errorState:"Estado de error",loadError:"Error de carga",loadErrorText:"Las entradas de Explore no se pudieron cargar ahora. Mensaje técnico:",noNew:"No se encontraron Mioseg QR nuevos",untitled:"Mioseg QR sin título",businessFallback:"Business Mioseg QR en mioseg qr",other:"Otro",away:"de distancia",follower:"Seguidor",followers:"Seguidores",view:"vista",views:"vistas",uniqueVisitors:"visitantes únicos",popularBadge:"🔥 Popular",strongInterest:"📈 Gran interés",manyVisitors:"👀 Muchos visitantes",trustProfile:"⭐ Perfil de confianza",highDemand:"🚀 Muy solicitado",newSince:"Nuevo desde",tapMarker:"Toca para mostrar el marcador",noLocationData:"Sin datos de ubicación",mapSelected:"Seleccionado en el mapa",selectedQrx:"📍 Mioseg QR seleccionado",topRank:"👑 N.º 1 en el área actual",more:"Mostrar más",browserNoGeo:"Este navegador no admite la ubicación.",geoFailed:"No se pudo obtener la ubicación.",geoPermission:"No se pudo obtener la ubicación. Permite el acceso a la ubicación en el navegador.",geoAllow:"No se pudo obtener la ubicación. Permite al navegador acceder a tu ubicación.",locationLoading:"Cargando ubicación ...",locationShort:"Ubicación ...",noNewArea:"No hay Mioseg QR nuevos en esta área",noNewAreaText:"Mueve el mapa o aleja el zoom para descubrir nuevos Business Mioseg QR en otra zona.",selectedSentence:"Este Mioseg QR está seleccionado actualmente en el mapa.",categories:{praxis_gesundheit:"Salud",gastronomie:"Gastronomía",unternehmen:"Empresa",dienstleistung:"Servicios",handwerk:"Oficios",event:"Evento",verein:"Asociación",wohltaetigkeit:"Organización benéfica",sehenswuerdigkeit:"Atracción",sonstiges:"Otro"}
  },
  it: {
    searchPlaceholder:"Cerca Mioseg QR",
    all:"Tutti",
    visible:"visibili",
    topFirst:"I migliori prima",
    chooseQrx:"Scegli quali Mioseg QR vuoi vedere",
    justCreated:"Creati di recente",
    tabsAria:"Schede dei risultati Explore",
    home:"Home",dashboard:"Dashboard",account:"Account",heroTitle:"Scopri i Business Mioseg QR vicino a te",heroText:"Trova ristoranti, studi, aziende, servizi e luoghi speciali su una moderna mappa pubblica. Ogni voce porta direttamente alla relativa vista web Mioseg QR.",viewEntries:"Visualizza voci",openMap:"Apri mappa",totalBusiness:"Business Mioseg QR totali",visibleHits:"risultati visibili",activeCategories:"categorie attive",verifiedProfiles:"profili verificati",totalFollowers:"follower totali",totalViews:"visualizzazioni totali",publicMap:"Mappa pubblica delle attività",publicMapText:"Cerca, filtra e apri Business Mioseg QR pubblici direttamente sulla mappa. Scopri nuovi luoghi, aziende e offerte nei dintorni.",search:"Cerca",map:"Mappa",verified:"Verificato",openQrx:"Apri Mioseg QR →",results:"Risultati",mapLive:"Cerca, sposta la mappa e scopri Mioseg QR in tempo reale",qrxMap:"Mappa Mioseg QR",qrxMapText:"Cerca Mioseg QR reali, vai alla tua posizione o sposta la mappa: i risultati sotto reagiscono in tempo reale all’area visualizzata.",noMatches:"Nessun Mioseg QR corrispondente trovato.",startSearch:"Avvia ricerca",nearMe:"Vicino a me",locationActive:"Posizione attiva",reset:"Reimposta",withLocation:"con posizione",mapUpdating:"Aggiornamento mappa …",currentResults:"Risultati nell’area corrente della mappa",defaultRanking:"Per impostazione predefinita mostriamo le voci più popolari. Puoi passare in qualsiasi momento a Mioseg QR vicini o nuovi.",locationOptional:"Posizione facoltativa",currentMapArea:"Area corrente della mappa",allVisible:"Tutti i Mioseg QR visibili",popular:"Popolari",rankingArea:"Classifica nell’area",distanceSorted:"Ordinati per distanza",activateLocation:"Attiva posizione",newLabel:"Nuovi",noVisible:"Nessun Mioseg QR nell’area visibile",noVisibleText:"Sposta la mappa o riduci lo zoom per vedere di nuovo Business Mioseg QR nell’area corrente.",popularArea:"Popolari nell’area",noPopular:"Nessun Mioseg QR popolare trovato",moveOrFilter:"Sposta la mappa o modifica i filtri.",nearbyText:"Ordinati in base alla distanza dalla tua posizione.",nearbyNoLocation:"Attiva la posizione per vedere Mioseg QR vicino a te.",activateLocationHint:"Fai clic su “Vicino a me” per mostrare qui i Business Mioseg QR più vicini.",newArea:"Nuovi nell’area",newestArea:"I Business Mioseg QR più recenti nell’area corrente.",errorState:"Stato di errore",loadError:"Errore di caricamento",loadErrorText:"Le voci Explore non possono essere caricate ora. Messaggio tecnico:",noNew:"Nessun nuovo Mioseg QR trovato",untitled:"Mioseg QR senza titolo",businessFallback:"Business Mioseg QR su mioseg qr",other:"Altro",away:"di distanza",follower:"Follower",followers:"Follower",view:"visualizzazione",views:"visualizzazioni",uniqueVisitors:"visitatori unici",popularBadge:"🔥 Popolare",strongInterest:"📈 Forte interesse",manyVisitors:"👀 Molti visitatori",trustProfile:"⭐ Profilo affidabile",highDemand:"🚀 Molto richiesto",newSince:"Nuovo dal",tapMarker:"Tocca per mostrare il marker",noLocationData:"Nessun dato di posizione",mapSelected:"Selezionato sulla mappa",selectedQrx:"📍 Mioseg QR selezionato",topRank:"👑 N. 1 nell’area corrente",more:"Mostra altro",browserNoGeo:"La posizione non è supportata da questo browser.",geoFailed:"Impossibile ottenere la posizione.",geoPermission:"Impossibile ottenere la posizione. Consenti l’accesso alla posizione nel browser.",geoAllow:"Impossibile ottenere la posizione. Consenti al browser di accedere alla tua posizione.",locationLoading:"Caricamento posizione ...",locationShort:"Posizione ...",noNewArea:"Nessun nuovo Mioseg QR in quest’area",noNewAreaText:"Sposta la mappa o riduci lo zoom per scoprire nuovi Business Mioseg QR in un’altra area.",selectedSentence:"Questo Mioseg QR è attualmente selezionato sulla mappa.",categories:{praxis_gesundheit:"Salute",gastronomie:"Ristorazione",unternehmen:"Azienda",dienstleistung:"Servizi",handwerk:"Artigianato",event:"Evento",verein:"Associazione",wohltaetigkeit:"Beneficenza",sehenswuerdigkeit:"Attrazione",sonstiges:"Altro"}
  },
} as const;
...
export default async function ExplorePage({
  ...
  // Eingeloggten Nutzer serverseitig ermitteln, damit Explore eigene Mioseg QR
  // genauso erkennt wie die Mioseg QR-Detailseite.
              ...
              >
                ...
                >
                  {isOwnQrx ? (
                    ...
                    >
                      {language === "de" ? "Mein Mioseg QR" : language === "en" ? "My Mioseg QR" : language === "tr" ? "Mioseg QR'im" : language === "pl" ? "Mój Mioseg QR" : language === "ar" ? "Mioseg QR الخاص بي" : language === "fr" ? "Mon Mioseg QR" : language === "es" ? "Mi Mioseg QR" : "Il mio Mioseg QR"}
                    </span>
                  ) : (
                    <ExploreFollowClient
                      qrxId={entry.id}
        ...
        <div className="mioseg-explore-compact-head">
          <div className={styles.sectionIntro} style={{ marginBottom: 0 }}>
            ...
            >
              ...
              <div className="mioseg-map-category-row" aria-label={`${ui.results} · ${ui.activeCategories}`}>
                ...
                >
                  {ui.all} <span>{publicEntries.length}</span>
                </Link>
          ...
          <div>
            <div className="mioseg-map-status-pills">
              ...
              <span>📌 <strong id="visibleMapCount">{mapPoints.length}</strong> {ui.visible}</span>
              <span>🔥 {ui.topFirst}</span>
            </div>
        ...
        <div id="explore-hub" className="mioseg-explore-hub">
          <div className="mioseg-explore-hub-head">
            ...
            <div className="mioseg-live-section-pills">
              <span><strong id="visibleMapCountHub">{mapPoints.length}</strong> {ui.visible}</span>
          ...
          <div className="mioseg-explore-tabs" aria-label={ui.tabsAria}>
          ...
          >
            <div className={styles.compareLabelFeatured}>Mioseg QR aktuell ausgewählt</div>
            <h3 id="activeMapQrxTitle" className={styles.compareTitleFeatured}>Mioseg QR ausgewählt</h3>
          ...
          <div className="mioseg-explore-tab-panels">
            <section className="mioseg-explore-tab-panel mioseg-panel-popular" aria-label={ui.popularArea}>
              <div className="mioseg-panel-title-row">
                ...
                <span>👑 Top Mioseg QR zuerst</span>
              </div>
...
(function(){
  ...
  function getVisibleCardMeta(id){
    ...
    return {
      id: id,
      title: card.getAttribute("data-visible-title") || "Mioseg QR",
      category: card.getAttribute("data-visible-category") || "Business Mioseg QR",
