...
const ACCOUNT_SECURITY_TEXT = {
  de: {
    ...
    deleteAccountText: "Diese Aktion kann nicht rückgängig gemacht werden. Deine Kontodaten, Credits und Zugänge werden entfernt; eigene Mioseg QR werden deaktiviert.",
  ...
  en: {
    ...
    deleteAccountText: "This action cannot be undone. Your account data, Credits and access will be removed; your own Mioseg QR will be disabled.",
  ...
  tr: {
    ...
    deleteAccountText: "Bu işlem geri alınamaz. Hesap verilerin, Credits ve erişimlerin kaldırılır; kendi Mioseg QR'lerin devre dışı bırakılır.",
  ...
  pl: {
    ...
    deleteAccountText: "Tej operacji nie można cofnąć. Dane konta, Credits i dostępy zostaną usunięte; własne Mioseg QR zostaną wyłączone.",
  ...
  ar: {
    ...
    deleteAccountText: "لا يمكن التراجع عن هذا الإجراء. ستتم إزالة بيانات حسابك وCredits ووسائل الوصول؛ وسيتم تعطيل Mioseg QR الخاصة بك.",
  ...
  fr: {
    ...
    deleteAccountText: "Cette action est irréversible. Vos données de compte, Credits et accès seront supprimés ; vos propres Mioseg QR seront désactivés.",
  ...
  es: {
    ...
    deleteAccountText: "Esta acción no se puede deshacer. Se eliminarán los datos de tu cuenta, Credits y accesos; tus propios Mioseg QR se desactivarán.",
  ...
  it: {
    ...
    deleteAccountText: "Questa azione non può essere annullata. I dati dell’account, i Credits e gli accessi verranno rimossi; i tuoi Mioseg QR saranno disattivati.",
