...
const SCAN_TEXT: Record<ScanLanguage, ScanCopy> = {
  de: {
    ...
    openMyQrx: "Meine Mioseg QR öffnen",
  ...
  pl: {
    ...
    openMyQrx: "Otwórz moje Mioseg QR",
  ...
  ar: {
    ...
    openMyQrx: "فتح Mioseg QR الخاصة بي",
  ...
  fr: {
    ...
    openMyQrx: "Ouvrir mes Mioseg QR",
  ...
  it: {
    ...
    openMyQrx: "Apri i miei Mioseg QR",
