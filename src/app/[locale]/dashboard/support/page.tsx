...
const SUPPORT_COPY = {
  de: {
    navAria:"Support Navigation", myQrx:"Meine Mioseg QR", account:"Konto", title:"Support & Hilfe", subtitle:"Melde Probleme, stelle Fragen und prüfe den Status deiner bisherigen Support-Anfragen.", back:"Zurück zum Dashboard", closeForm:"Formular schließen", newRequest:"+ Neue Anfrage", overview:"Support Übersicht", open:"Offen", inReview:"In Bearbeitung", resolved:"Gelöst", email:"E-Mail", followUps:"Rückfragen", newSupport:"Neue Support-Anfrage", formHint:"Beschreibe dein Anliegen möglichst genau. Falls nötig melden wir uns per E-Mail bei dir.", newLabel:"Neu", category:"Kategorie", subject:"Betreff", subjectPlaceholder:"Kurze Beschreibung des Problems", description:"Beschreibung", descriptionPlaceholder:"Was ist passiert? Was hast du bereits versucht?", affectedQrx:"Betroffener Mioseg QR (optional)", noSpecificQrx:"Kein bestimmter Mioseg QR", notice:"Rückfragen und weitere Informationen erhältst du an die E-Mail-Adresse deines Mioseg-qr-Kontos.", sending:"Wird gesendet …", send:"Anfrage absenden", myRequests:"Meine Anfragen", requestsHint:"Hier siehst du Ticketnummer, Kategorie und Bearbeitungsstatus.", loading:"Lädt", tickets:"Tickets", loadingRequests:"Support-Anfragen werden geladen …", noRequests:"Noch keine Support-Anfragen", noRequestsHint:"Sobald du eine Anfrage sendest, erscheint sie hier und wird gleichzeitig im Adminbereich angezeigt.", supportTicket:"Support-Ticket", completion:"Abschluss:", waitingCustomer:"Warten auf deine Rückmeldung", other:"Sonstiges", untitledQrx:"Unbenannter Mioseg QR", loginRequired:"Bitte melde dich zuerst an.", loadFailed:"Support-Anfragen konnten nicht geladen werden.", centerFailed:"Support-Center konnte nicht geladen werden.", subjectRequired:"Bitte gib einen aussagekräftigen Betreff ein.", descriptionRequired:"Bitte beschreibe dein Anliegen mit mindestens 10 Zeichen.", sendFailed:"Die Anfrage konnte nicht gesendet werden.", sent:"Deine Support-Anfrage wurde übermittelt. Bei Rückfragen kontaktieren wir dich per E-Mail.", creditsWrong:"Credits oder Zahlung", verificationWaiting:"Verifizierung", uploadProblem:"Upload oder Dateien", transferProblem:"Mioseg QR-Transfer", qrxReport:"Mioseg QR oder Inhalt melden"
  },
  en: {
    navAria:"Support navigation", myQrx:"My Mioseg QR", account:"Account", title:"Support & Help", subtitle:"Report problems, ask questions and check the status of your previous support requests.", back:"Back to dashboard", closeForm:"Close form", newRequest:"+ New request", overview:"Support overview", open:"Open", inReview:"In review", resolved:"Resolved", email:"Email", followUps:"Follow-ups", newSupport:"New support request", formHint:"Describe your issue as precisely as possible. If necessary, we will contact you by email.", newLabel:"New", category:"Category", subject:"Subject", subjectPlaceholder:"Short description of the problem", description:"Description", descriptionPlaceholder:"What happened? What have you already tried?", affectedQrx:"Affected Mioseg QR (optional)", noSpecificQrx:"No specific Mioseg QR", notice:"Follow-up questions and further information will be sent to the email address of your Mioseg qr account.", sending:"Sending …", send:"Send request", myRequests:"My requests", requestsHint:"Here you can see the ticket number, category and processing status.", loading:"Loading", tickets:"tickets", loadingRequests:"Loading support requests …", noRequests:"No support requests yet", noRequestsHint:"As soon as you send a request, it will appear here and also in the admin area.", supportTicket:"Support ticket", completion:"Resolution:", waitingCustomer:"Waiting for your reply", other:"Other", untitledQrx:"Untitled Mioseg QR", loginRequired:"Please sign in first.", loadFailed:"Support requests could not be loaded.", centerFailed:"Support center could not be loaded.", subjectRequired:"Please enter a meaningful subject.", descriptionRequired:"Please describe your issue using at least 10 characters.", sendFailed:"The request could not be sent.", sent:"Your support request has been submitted. We will contact you by email if we have questions.", creditsWrong:"Credits or payment", verificationWaiting:"Verification", uploadProblem:"Upload or files", transferProblem:"Mioseg QR transfer", qrxReport:"Report Mioseg QR or content"
  },
  tr: {
    navAria:"Destek navigasyonu", myQrx:"Mioseg QR'lerim", account:"Hesap", title:"Destek ve Yardım", subtitle:"Sorunları bildirin, sorular sorun ve önceki destek taleplerinizin durumunu kontrol edin.", back:"Kontrol paneline dön", closeForm:"Formu kapat", newRequest:"+ Yeni talep", overview:"Destek özeti", open:"Açık", inReview:"İnceleniyor", resolved:"Çözüldü", email:"E-posta", followUps:"Geri dönüşler", newSupport:"Yeni destek talebi", formHint:"Talebinizi mümkün olduğunca ayrıntılı açıklayın. Gerekirse sizinle e-posta yoluyla iletişime geçeriz.", newLabel:"Yeni", category:"Kategori", subject:"Konu", subjectPlaceholder:"Sorunun kısa açıklaması", description:"Açıklama", descriptionPlaceholder:"Ne oldu? Şimdiye kadar neleri denediniz?", affectedQrx:"İlgili Mioseg QR (isteğe bağlı)", noSpecificQrx:"Belirli bir Mioseg QR yok", notice:"Sorular ve ek bilgiler Mioseg qr hesabınızdaki e-posta adresine gönderilir.", sending:"Gönderiliyor …", send:"Talebi gönder", myRequests:"Taleplerim", requestsHint:"Burada talep numarasını, kategoriyi ve işlem durumunu görebilirsiniz.", loading:"Yükleniyor", tickets:"talep", loadingRequests:"Destek talepleri yükleniyor …", noRequests:"Henüz destek talebi yok", noRequestsHint:"Bir talep gönderdiğinizde burada ve aynı zamanda yönetici alanında görünür.", supportTicket:"Destek talebi", completion:"Çözüm:", waitingCustomer:"Yanıtınız bekleniyor", other:"Diğer", untitledQrx:"Adsız Mioseg QR", loginRequired:"Lütfen önce giriş yapın.", loadFailed:"Destek talepleri yüklenemedi.", centerFailed:"Destek merkezi yüklenemedi.", subjectRequired:"Lütfen açıklayıcı bir konu girin.", descriptionRequired:"Lütfen talebinizi en az 10 karakterle açıklayın.", sendFailed:"Talep gönderilemedi.", sent:"Destek talebiniz iletildi. Sorularımız olursa sizinle e-posta yoluyla iletişime geçeceğiz.", creditsWrong:"Credits veya ödeme", verificationWaiting:"Doğrulama", uploadProblem:"Yükleme veya dosyalar", transferProblem:"Mioseg QR transferi", qrxReport:"Mioseg QR veya içeriği bildir"
  },
  pl: {
    navAria:"Nawigacja pomocy", myQrx:"Moje Mioseg QR", account:"Konto", title:"Pomoc i wsparcie", subtitle:"Zgłaszaj problemy, zadawaj pytania i sprawdzaj status wcześniejszych zgłoszeń.", back:"Wróć do panelu", closeForm:"Zamknij formularz", newRequest:"+ Nowe zgłoszenie", overview:"Przegląd wsparcia", open:"Otwarte", inReview:"W trakcie", resolved:"Rozwiązane", email:"E-mail", followUps:"Pytania zwrotne", newSupport:"Nowe zgłoszenie", formHint:"Opisz problem możliwie dokładnie. W razie potrzeby skontaktujemy się z Tobą e-mailem.", newLabel:"Nowe", category:"Kategoria", subject:"Temat", subjectPlaceholder:"Krótki opis problemu", description:"Opis", descriptionPlaceholder:"Co się stało? Czego już próbowałeś?", affectedQrx:"Dotyczący Mioseg QR (opcjonalnie)", noSpecificQrx:"Brak konkretnego Mioseg QR", notice:"Pytania i dalsze informacje otrzymasz na adres e-mail konta Mioseg qr.", sending:"Wysyłanie …", send:"Wyślij zgłoszenie", myRequests:"Moje zgłoszenia", requestsHint:"Tutaj zobaczysz numer zgłoszenia, kategorię i status.", loading:"Ładowanie", tickets:"zgłoszeń", loadingRequests:"Ładowanie zgłoszeń …", noRequests:"Brak zgłoszeń", noRequestsHint:"Po wysłaniu zgłoszenia pojawi się ono tutaj oraz w panelu administracyjnym.", supportTicket:"Zgłoszenie", completion:"Rozwiązanie:", waitingCustomer:"Oczekuje na Twoją odpowiedź", other:"Inne", untitledQrx:"Mioseg QR bez nazwy", loginRequired:"Najpierw się zaloguj.", loadFailed:"Nie udało się załadować zgłoszeń.", centerFailed:"Nie udało się załadować centrum pomocy.", subjectRequired:"Wpisz konkretny temat.", descriptionRequired:"Opisz problem używając co najmniej 10 znaków.", sendFailed:"Nie udało się wysłać zgłoszenia.", sent:"Twoje zgłoszenie zostało przesłane. W razie pytań skontaktujemy się e-mailem.", creditsWrong:"Credits lub płatność", verificationWaiting:"Weryfikacja", uploadProblem:"Przesyłanie lub pliki", transferProblem:"Transfer Mioseg QR", qrxReport:"Zgłoś Mioseg QR lub treść"
  },
  ar: {
    navAria:"تنقل الدعم", myQrx:"Mioseg QR الخاصة بي", account:"الحساب", title:"الدعم والمساعدة", subtitle:"أبلغ عن المشكلات واطرح الأسئلة وتحقق من حالة طلبات الدعم السابقة.", back:"العودة إلى لوحة التحكم", closeForm:"إغلاق النموذج", newRequest:"+ طلب جديد", overview:"نظرة عامة على الدعم", open:"مفتوح", inReview:"قيد المراجعة", resolved:"تم الحل", email:"البريد الإلكتروني", followUps:"استفسارات", newSupport:"طلب دعم جديد", formHint:"صف مشكلتك بأكبر قدر ممكن من الدقة. سنتواصل معك عبر البريد الإلكتروني عند الحاجة.", newLabel:"جديد", category:"الفئة", subject:"الموضوع", subjectPlaceholder:"وصف مختصر للمشكلة", description:"الوصف", descriptionPlaceholder:"ماذا حدث؟ ماذا جربت حتى الآن؟", affectedQrx:"Mioseg QR المتأثر (اختياري)", noSpecificQrx:"لا يوجد Mioseg QR محدد", notice:"ستتلقى الاستفسارات والمعلومات الإضافية على عنوان البريد الإلكتروني لحساب Mioseg qr.", sending:"جارٍ الإرسال …", send:"إرسال الطلب", myRequests:"طلباتي", requestsHint:"هنا ترى رقم الطلب والفئة وحالة المعالجة.", loading:"جارٍ التحميل", tickets:"طلبات", loadingRequests:"جارٍ تحميل طلبات الدعم …", noRequests:"لا توجد طلبات دعم بعد", noRequestsHint:"بمجرد إرسال طلب سيظهر هنا وفي منطقة الإدارة أيضًا.", supportTicket:"طلب دعم", completion:"الحل:", waitingCustomer:"بانتظار ردك", other:"أخرى", untitledQrx:"Mioseg QR بدون اسم", loginRequired:"يرجى تسجيل الدخول أولاً.", loadFailed:"تعذر تحميل طلبات الدعم.", centerFailed:"تعذر تحميل مركز الدعم.", subjectRequired:"يرجى إدخال موضوع واضح.", descriptionRequired:"يرجى وصف طلبك بما لا يقل عن 10 أحرف.", sendFailed:"تعذر إرسال الطلب.", sent:"تم إرسال طلب الدعم. سنتواصل معك عبر البريد الإلكتروني إذا كانت لدينا أسئلة.", creditsWrong:"Credits أو الدفع", verificationWaiting:"التحقق", uploadProblem:"الرفع أو الملفات", transferProblem:"نقل Mioseg QR", qrxReport:"الإبلاغ عن Mioseg QR أو محتوى"
  },
  fr: {
    navAria:"Navigation assistance", myQrx:"Mes Mioseg QR", account:"Compte", title:"Assistance et aide", subtitle:"Signalez des problèmes, posez des questions et consultez l’état de vos demandes précédentes.", back:"Retour au tableau de bord", closeForm:"Fermer le formulaire", newRequest:"+ Nouvelle demande", overview:"Aperçu de l’assistance", open:"Ouvert", inReview:"En cours", resolved:"Résolu", email:"E-mail", followUps:"Questions", newSupport:"Nouvelle demande d’assistance", formHint:"Décrivez votre problème aussi précisément que possible. Si nécessaire, nous vous contacterons par e-mail.", newLabel:"Nouveau", category:"Catégorie", subject:"Objet", subjectPlaceholder:"Brève description du problème", description:"Description", descriptionPlaceholder:"Que s’est-il passé ? Qu’avez-vous déjà essayé ?", affectedQrx:"Mioseg QR concerné (facultatif)", noSpecificQrx:"Aucun Mioseg QR particulier", notice:"Les questions et informations complémentaires seront envoyées à l’adresse e-mail de votre compte Mioseg qr.", sending:"Envoi …", send:"Envoyer la demande", myRequests:"Mes demandes", requestsHint:"Vous voyez ici le numéro, la catégorie et le statut de traitement.", loading:"Chargement", tickets:"demandes", loadingRequests:"Chargement des demandes …", noRequests:"Aucune demande pour le moment", noRequestsHint:"Dès que vous envoyez une demande, elle apparaît ici ainsi que dans l’espace d’administration.", supportTicket:"Demande d’assistance", completion:"Résolution :", waitingCustomer:"En attente de votre réponse", other:"Autre", untitledQrx:"Mioseg QR sans nom", loginRequired:"Veuillez d’abord vous connecter.", loadFailed:"Impossible de charger les demandes d’assistance.", centerFailed:"Impossible de charger le centre d’assistance.", subjectRequired:"Veuillez saisir un objet explicite.", descriptionRequired:"Veuillez décrire votre demande avec au moins 10 caractères.", sendFailed:"La demande n’a pas pu être envoyée.", sent:"Votre demande d’assistance a été envoyée. Nous vous contacterons par e-mail si nécessaire.", creditsWrong:"Credits ou paiement", verificationWaiting:"Vérification", uploadProblem:"Téléversement ou fichiers", transferProblem:"Transfert Mioseg QR", qrxReport:"Signaler un Mioseg QR ou un contenu"
  },
  es: {
    navAria:"Navegación de soporte", myQrx:"Mis Mioseg QR", account:"Cuenta", title:"Soporte y ayuda", subtitle:"Informa de problemas, haz preguntas y consulta el estado de tus solicitudes anteriores.", back:"Volver al panel", closeForm:"Cerrar formulario", newRequest:"+ Nueva solicitud", overview:"Resumen de soporte", open:"Abierto", inReview:"En revisión", resolved:"Resuelto", email:"Correo electrónico", followUps:"Consultas", newSupport:"Nueva solicitud de soporte", formHint:"Describe tu problema con la mayor precisión posible. Si es necesario, nos pondremos en contacto contigo por correo electrónico.", newLabel:"Nuevo", category:"Categoría", subject:"Asunto", subjectPlaceholder:"Breve descripción del problema", description:"Descripción", descriptionPlaceholder:"¿Qué ha ocurrido? ¿Qué has probado ya?", affectedQrx:"Mioseg QR afectado (opcional)", noSpecificQrx:"Ningún Mioseg QR específico", notice:"Las consultas y la información adicional se enviarán al correo electrónico de tu cuenta Mioseg qr.", sending:"Enviando …", send:"Enviar solicitud", myRequests:"Mis solicitudes", requestsHint:"Aquí puedes ver el número, la categoría y el estado de tramitación.", loading:"Cargando", tickets:"solicitudes", loadingRequests:"Cargando solicitudes de soporte …", noRequests:"Aún no hay solicitudes", noRequestsHint:"Cuando envíes una solicitud, aparecerá aquí y también en el área de administración.", supportTicket:"Solicitud de soporte", completion:"Resolución:", waitingCustomer:"Esperando tu respuesta", other:"Otro", untitledQrx:"Mioseg QR sin nombre", loginRequired:"Inicia sesión primero.", loadFailed:"No se pudieron cargar las solicitudes de soporte.", centerFailed:"No se pudo cargar el centro de soporte.", subjectRequired:"Introduce un asunto descriptivo.", descriptionRequired:"Describe tu solicitud con al menos 10 caracteres.", sendFailed:"No se pudo enviar la solicitud.", sent:"Tu solicitud de soporte ha sido enviada. Si tenemos preguntas, nos pondremos en contacto contigo por correo electrónico.", creditsWrong:"Credits o pago", verificationWaiting:"Verificación", uploadProblem:"Carga o archivos", transferProblem:"Transferencia de Mioseg QR", qrxReport:"Informar de Mioseg QR o contenido"
  },
  it: {
    navAria:"Navigazione supporto", myQrx:"I miei Mioseg QR", account:"Account", title:"Supporto e aiuto", subtitle:"Segnala problemi, fai domande e controlla lo stato delle richieste precedenti.", back:"Torna alla dashboard", closeForm:"Chiudi modulo", newRequest:"+ Nuova richiesta", overview:"Panoramica supporto", open:"Aperto", inReview:"In lavorazione", resolved:"Risolto", email:"E-mail", followUps:"Domande", newSupport:"Nuova richiesta di supporto", formHint:"Descrivi il problema nel modo più preciso possibile. Se necessario, ti contatteremo via e-mail.", newLabel:"Nuovo", category:"Categoria", subject:"Oggetto", subjectPlaceholder:"Breve descrizione del problema", description:"Descrizione", descriptionPlaceholder:"Cosa è successo? Cosa hai già provato?", affectedQrx:"Mioseg QR interessato (opzionale)", noSpecificQrx:"Nessun Mioseg QR specifico", notice:"Domande e ulteriori informazioni saranno inviate all’indirizzo e-mail del tuo account Mioseg qr.", sending:"Invio …", send:"Invia richiesta", myRequests:"Le mie richieste", requestsHint:"Qui puoi vedere numero, categoria e stato di elaborazione.", loading:"Caricamento", tickets:"richieste", loadingRequests:"Caricamento richieste di supporto …", noRequests:"Nessuna richiesta di supporto", noRequestsHint:"Quando invii una richiesta, apparirà qui e anche nell’area amministrativa.", supportTicket:"Richiesta di supporto", completion:"Risoluzione:", waitingCustomer:"In attesa della tua risposta", other:"Altro", untitledQrx:"Mioseg QR senza nome", loginRequired:"Accedi prima.", loadFailed:"Impossibile caricare le richieste di supporto.", centerFailed:"Impossibile caricare il centro di supporto.", subjectRequired:"Inserisci un oggetto significativo.", descriptionRequired:"Descrivi la richiesta con almeno 10 caratteri.", sendFailed:"Impossibile inviare la richiesta.", sent:"La tua richiesta di supporto è stata inviata. Ti contatteremo via e-mail in caso di domande.", creditsWrong:"Credits o pagamento", verificationWaiting:"Verifica", uploadProblem:"Caricamento o file", transferProblem:"Trasferimento Mioseg QR", qrxReport:"Segnala Mioseg QR o contenuto"
  },
} as const;
  ...
  async function loadSupportCenter() {
    ...
    try {
      ...
      if (qrxResponse.error) {
        console.warn(
          "Eigene Mioseg QR konnten nicht geladen werden:",
