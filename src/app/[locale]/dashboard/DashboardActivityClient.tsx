...
const ACTIVITY_TEXT: Record<ActivityLocale, ActivityCopy> = {
  de: {
    ...
    savedQrx: "Gespeicherter Mioseg QR",
    loading: "Änderungen werden geladen …",
    empty: "Seit dem Speichern gab es noch keine Änderungen an deinen gespeicherten Mioseg QR.",
    changedBadge: "Gespeicherter Mioseg QR geändert",
  },
  en: {
    ...
    empty: "There have been no changes to your saved Mioseg QR since you saved them.",
    changedBadge: "Saved Mioseg QR changed",
  },
  tr: {
    ...
    empty: "Kaydettiğinizden beri kayıtlı Mioseg QR'lerinizde herhangi bir değişiklik olmadı.",
    changedBadge: "Kaydedilen Mioseg QR değiştirildi",
  },
  pl: {
    ...
    savedQrx: "Zapisany Mioseg QR",
    loading: "Ładowanie zmian …",
    empty: "Od momentu zapisania nie było żadnych zmian w zapisanych Mioseg QR.",
    changedBadge: "Zapisany Mioseg QR został zmieniony",
  },
  ar: {
    ...
    savedQrx: "Mioseg QR محفوظ",
    loading: "جارٍ تحميل التغييرات …",
    empty: "لم تحدث أي تغييرات على Mioseg QR المحفوظة منذ حفظها.",
    changedBadge: "تم تغيير Mioseg QR محفوظ",
  },
  fr: {
    ...
    savedQrx: "Mioseg QR enregistré",
    loading: "Chargement des modifications …",
    empty: "Aucune modification n’a été apportée à vos Mioseg QR enregistrés depuis leur enregistrement.",
    changedBadge: "Mioseg QR enregistré modifié",
  },
  es: {
    ...
    savedQrx: "Mioseg QR guardado",
    loading: "Cargando cambios …",
    empty: "No ha habido cambios en tus Mioseg QR guardados desde que los guardaste.",
    changedBadge: "Mioseg QR guardado modificado",
  },
  it: {
    ...
    savedQrx: "Mioseg QR salvato",
    loading: "Caricamento modifiche …",
    empty: "Non ci sono state modifiche ai Mioseg QR salvati da quando li hai salvati.",
    changedBadge: "Mioseg QR salvato modificato",
  },
};
...
export default function DashboardActivityClient({
  ...
  async function loadActivities() {
    ...
    if (savesError) {
      console.warn("Dashboard saved Mioseg QR error:", savesError.message);
      setItems([]);
      setLoading(false);
      return;
    }
