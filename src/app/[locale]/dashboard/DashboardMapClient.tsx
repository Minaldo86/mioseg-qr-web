...
const MAP_TEXT = {
  de: {
    legendOwnBusiness: "Gold = Mein Business Mioseg QR",
    legendSavedBusiness: "Dunkelgrün = Gespeichertes Business Mioseg QR",
    legendOwnNormal: "Hellgrün = Mein normaler Mioseg QR",
    legendSavedNormal: "Lila = Gespeicherter Mioseg QR",
    legendScan: "Blau = Normaler Scan",
    filterAll: "Alle",
    filterOwn: "Meine Mioseg QR",
    ...
    marker: "Marker",
    untitledQrx: "Unbenannter Mioseg QR",
    ...
    searchPlaceholder: "Mioseg QR, Ort oder Kategorie suchen …",
    entry: "Eintrag",
    entries: "Einträge",
    loaded: "geladen",
    ...
    mapEmpty: "Im aktuellen Kartenausschnitt wurden keine passenden Mioseg QR oder Scans gefunden.",
  ...
  en: {
    legendOwnBusiness: "Gold = My Business Mioseg QR",
    legendSavedBusiness: "Dark green = Saved Business Mioseg QR",
    legendOwnNormal: "Light green = My normal Mioseg QR",
    legendSavedNormal: "Purple = Saved Mioseg QR",
    legendScan: "Blue = Normal scan",
    filterAll: "All",
    filterOwn: "My Mioseg QR",
    filterSaved: "Saved",
    filterBusiness: "Business",
    filterNormal: "Normal",
    filterScan: "QR codes",
    ...
    marker: "Marker",
    untitledQrx: "Untitled Mioseg QR",
    ...
    searchPlaceholder: "Search Mioseg QR, place or category …",
    entry: "entry",
    entries: "entries",
    loaded: "loaded",
    ...
    mapEmpty: "No matching Mioseg QR or scans were found in the current map area.",
  ...
  tr: {
    legendOwnBusiness: "Altın = Benim Business Mioseg QR",
    legendSavedBusiness: "Koyu yeşil = Kaydedilen Business Mioseg QR",
    legendOwnNormal: "Açık yeşil = Benim normal Mioseg QR",
    legendSavedNormal: "Mor = Kaydedilen Mioseg QR",
    legendScan: "Mavi = Normal tarama",
    filterAll: "Tümü",
    filterOwn: "Mioseg QR'lerim",
    ...
    marker: "İşaretçi",
    untitledQrx: "Adsız Mioseg QR",
    qrxFallback: "mioseg qr üzerindeki Mioseg QR",
    ...
    searchPlaceholder: "Mioseg QR, yer veya kategori ara …",
    entry: "kayıt",
    entries: "kayıt",
    loaded: "yüklendi",
    ...
    mapEmpty: "Mevcut harita alanında eşleşen Mioseg QR veya tarama bulunamadı.",
  ...
  pl: {
    legendOwnBusiness: "Złoty = Mój Business Mioseg QR",
    legendSavedBusiness: "Ciemnozielony = Zapisany Business Mioseg QR",
    legendOwnNormal: "Jasnozielony = Mój zwykły Mioseg QR",
    legendSavedNormal: "Fioletowy = Zapisany Mioseg QR",
    legendScan: "Niebieski = Zwykły skan",
    filterAll: "Wszystkie",
    filterOwn: "Moje Mioseg QR",
    ...
    marker: "Znacznik",
    untitledQrx: "Mioseg QR bez nazwy",
    ...
    searchPlaceholder: "Szukaj Mioseg QR, miejsca lub kategorii …",
    entry: "wpis",
    entries: "wpisów",
    loaded: "wczytano",
    ...
    mapEmpty: "W bieżącym obszarze mapy nie znaleziono pasujących Mioseg QR ani skanów.",
  ...
  ar: {
    legendOwnBusiness: "ذهبي = Business Mioseg QR الخاصة بي",
    legendSavedBusiness: "أخضر داكن = Business Mioseg QR محفوظة",
    legendOwnNormal: "أخضر فاتح = Mioseg QR عادية خاصة بي",
    legendSavedNormal: "بنفسجي = Mioseg QR محفوظة",
    legendScan: "أزرق = مسح عادي",
    filterAll: "الكل",
    filterOwn: "Mioseg QR الخاصة بي",
    ...
    marker: "علامة",
    untitledQrx: "Mioseg QR بدون اسم",
    ...
    searchPlaceholder: "ابحث عن Mioseg QR أو موقع أو فئة …",
    entry: "إدخال",
    entries: "إدخالات",
    loaded: "تم التحميل",
    ...
    mapEmpty: "لم يتم العثور على Mioseg QR أو عمليات مسح مطابقة في منطقة الخريطة الحالية.",
  ...
  fr: {
    legendOwnBusiness: "Or = Mon Business Mioseg QR",
    legendSavedBusiness: "Vert foncé = Business Mioseg QR enregistré",
    legendOwnNormal: "Vert clair = Mon Mioseg QR normal",
    legendSavedNormal: "Violet = Mioseg QR enregistré",
    legendScan: "Bleu = Scan normal",
    filterAll: "Tous",
    filterOwn: "Mes Mioseg QR",
    ...
    marker: "Marqueur",
    untitledQrx: "Mioseg QR sans titre",
    ...
    searchPlaceholder: "Rechercher un Mioseg QR, un lieu ou une catégorie …",
    entry: "entrée",
    entries: "entrées",
    loaded: "chargées",
    ...
    mapEmpty: "Aucun Mioseg QR ou scan correspondant n’a été trouvé dans la zone actuelle.",
  ...
  es: {
    legendOwnBusiness: "Dorado = Mi Business Mioseg QR",
    legendSavedBusiness: "Verde oscuro = Business Mioseg QR guardado",
    legendOwnNormal: "Verde claro = Mi Mioseg QR normal",
    legendSavedNormal: "Morado = Mioseg QR guardado",
    legendScan: "Azul = Escaneo normal",
    filterAll: "Todos",
    filterOwn: "Mis Mioseg QR",
    ...
    marker: "Marcador",
    untitledQrx: "Mioseg QR sin título",
    ...
    searchPlaceholder: "Buscar Mioseg QR, lugar o categoría …",
    entry: "entrada",
    entries: "entradas",
    loaded: "cargadas",
    ...
    mapEmpty: "No se encontraron Mioseg QR ni escaneos coincidentes en el área actual del mapa.",
  ...
  it: {
    legendOwnBusiness: "Oro = Il mio Business Mioseg QR",
    legendSavedBusiness: "Verde scuro = Business Mioseg QR salvato",
    legendOwnNormal: "Verde chiaro = Il mio Mioseg QR normale",
    legendSavedNormal: "Viola = Mioseg QR salvato",
    legendScan: "Blu = Scansione normale",
    filterAll: "Tutti",
    filterOwn: "I miei Mioseg QR",
    filterSaved: "Salvati",
    filterBusiness: "Business",
    ...
    marker: "Indicatore",
    untitledQrx: "Mioseg QR senza titolo",
    ...
    searchPlaceholder: "Cerca Mioseg QR, luogo o categoria …",
    entry: "elemento",
    entries: "elementi",
    loaded: "caricati",
    ...
    mapEmpty: "Nell’area corrente della mappa non sono stati trovati Mioseg QR o scansioni corrispondenti.",
