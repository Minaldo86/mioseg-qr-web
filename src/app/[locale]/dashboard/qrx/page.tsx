...
const QRLIST_TEXT = {
  de: {
    navLabel: "Mioseg QR Navigation",
    dashboard: "Dashboard",
    explore: "Explore",
    shareText: "Mioseg QR: {{title}}",
    untitled: "Unbenannter Mioseg QR",
    qrxFallback: "Mioseg QR auf mioseg qr",
    loginRequired: "Bitte melde dich zuerst an, um deine Mioseg QR zu sehen.",
    copyFailed: "Link konnte nicht kopiert werden.",
    deleteConfirm: "Möchtest du diesen Mioseg QR wirklich löschen?\n\n{{title}}\n\nDer Mioseg QR wird aus deinem Konto entfernt.",
    sessionExpired: "Deine Sitzung ist abgelaufen. Bitte melde dich erneut an.",
    deleteFailed: "Mioseg QR konnte nicht gelöscht werden.",
    removeSavedConfirm: "Möchtest du diesen gespeicherten Mioseg QR entfernen?\n\n{{title}}",
    loginAgain: "Bitte melde dich erneut an.",
    removeFailed: "Mioseg QR konnte nicht entfernt werden.",
    ownQrx: "Eigene Mioseg QR",
    ...
    savedText: "Alle Mioseg QR, denen du folgst. Änderungen werden automatisch mit der App synchronisiert.",
    myQrx: "Meine Mioseg QR",
    heroText: "Verwalte deine eigenen Mioseg QR und gespeicherten Mioseg QR bequem im Browser.",
    create: "Mioseg QR erstellen",
    backDashboard: "Zurück zum Dashboard",
    loading: "Lädt ...",
    count: "{{filtered}} von {{total}} Einträgen",
    search: "Mioseg QR suchen",
    searchPlaceholder: "Titel, Firma, Ort oder Kategorie suchen …",
    clearSearch: "Suche löschen",
    noneOwn: "Noch keine Mioseg QR erstellt",
    noneSaved: "Noch keine Mioseg QR gespeichert",
    noneOwnText: "Sobald du deinen ersten Mioseg QR erstellt hast, erscheint er hier in deiner Web-Verwaltung.",
    noneSavedText: "Sobald du einem Mioseg QR folgst, erscheint er hier automatisch.",
    openExplore: "Explore öffnen",
    noMatch: "Kein passender Mioseg QR gefunden",
    noMatchText: "Prüfe den Suchbegriff oder lösche die Suche.",
    loadingQrx: "Mioseg QR werden geladen …",
    businessBadge: "🏢 Business Mioseg QR",
    normalBadge: "⌗ Normaler Mioseg QR",
    created: "Erstellt",
    views: "Mioseg QR Aufrufe",
    followers: "Follower",
  ...
  en: {
    ...
    explore: "Explore",
    shareText: "Mioseg QR: {{title}}",
    untitled: "Untitled Mioseg QR",
    qrxFallback: "Mioseg QR on mioseg qr",
    loginRequired: "Please sign in first to view your Mioseg QR.",
    copyFailed: "The link could not be copied.",
    deleteConfirm: "Do you really want to delete this Mioseg QR?\n\n{{title}}\n\nThe Mioseg QR will be removed from your account.",
    sessionExpired: "Your session has expired. Please sign in again.",
    deleteFailed: "The Mioseg QR could not be deleted.",
    removeSavedConfirm: "Do you want to remove this saved Mioseg QR?\n\n{{title}}",
    loginAgain: "Please sign in again.",
    removeFailed: "The Mioseg QR could not be removed.",
    ownQrx: "My Mioseg QR",
    ...
    savedText: "All Mioseg QR you follow. Changes are automatically synced with the app.",
    myQrx: "My Mioseg QR",
    heroText: "Manage your own and saved Mioseg QR conveniently in the browser.",
    create: "Create Mioseg QR",
    backDashboard: "Back to dashboard",
    loading: "Loading ...",
    count: "{{filtered}} of {{total}} entries",
    search: "Search Mioseg QR",
    searchPlaceholder: "Search title, company, location or category …",
    clearSearch: "Clear search",
    noneOwn: "No Mioseg QR created yet",
    noneSaved: "No Mioseg QR saved yet",
    noneOwnText: "Once you create your first Mioseg QR, it will appear here in your web management.",
    noneSavedText: "Once you follow a Mioseg QR, it will appear here automatically.",
    openExplore: "Open Explore",
    noMatch: "No matching Mioseg QR found",
    noMatchText: "Check the search term or clear the search.",
    loadingQrx: "Loading Mioseg QR …",
    businessBadge: "🏢 Business Mioseg QR",
    normalBadge: "⌗ Normal Mioseg QR",
    created: "Created",
    views: "Mioseg QR views",
    followers: "Followers",
  ...
  tr: {
    navLabel: "Mioseg QR navigasyonu",
    dashboard: "Kontrol paneli",
    explore: "Explore",
    shareText: "Mioseg QR: {{title}}",
    untitled: "Adsız Mioseg QR",
    qrxFallback: "mioseg qr üzerinde Mioseg QR",
    loginRequired: "Mioseg QR'lerini görmek için önce giriş yap.",
    copyFailed: "Bağlantı kopyalanamadı.",
    deleteConfirm: "Bu Mioseg QR'i gerçekten silmek istiyor musun?\n\n{{title}}\n\nMioseg QR hesabından kaldırılacak.",
    sessionExpired: "Oturumunun süresi doldu. Lütfen tekrar giriş yap.",
    deleteFailed: "Mioseg QR silinemedi.",
    removeSavedConfirm: "Bu kayıtlı Mioseg QR'i kaldırmak istiyor musun?\n\n{{title}}",
    loginAgain: "Lütfen tekrar giriş yap.",
    removeFailed: "Mioseg QR kaldırılamadı.",
    ownQrx: "Mioseg QR'lerim",
    savedQrx: "Kayıtlı Mioseg QR'ler",
    businessQrx: "Business Mioseg QR",
    normalQrx: "Normal Mioseg QR",
    verified: "Doğrulandı",
    ...
    savedText: "Takip ettiğin tüm Mioseg QR'ler. Değişiklikler uygulamayla otomatik senkronize edilir.",
    myQrx: "Mioseg QR'lerim",
    heroText: "Kendi ve kayıtlı Mioseg QR'lerini tarayıcıdan kolayca yönet.",
    create: "Mioseg QR oluştur",
    backDashboard: "Kontrol paneline dön",
    loading: "Yükleniyor ...",
    count: "{{total}} kayıttan {{filtered}} tanesi",
    search: "Mioseg QR ara",
    searchPlaceholder: "Başlık, firma, konum veya kategori ara …",
    clearSearch: "Aramayı temizle",
    noneOwn: "Henüz Mioseg QR oluşturulmadı",
    noneSaved: "Henüz Mioseg QR kaydedilmedi",
    noneOwnText: "İlk Mioseg QR'ini oluşturduğunda burada görünecek.",
    noneSavedText: "Bir Mioseg QR'i takip ettiğinde burada otomatik görünecek.",
    openExplore: "Explore'u aç",
    noMatch: "Eşleşen Mioseg QR bulunamadı",
    noMatchText: "Arama terimini kontrol et veya aramayı temizle.",
    loadingQrx: "Mioseg QR yükleniyor …",
    businessBadge: "🏢 Business Mioseg QR",
    normalBadge: "⌗ Normal Mioseg QR",
    created: "Oluşturuldu",
    views: "Mioseg QR görüntüleme",
  ...
  pl: {
    navLabel: "Nawigacja Mioseg QR",
    dashboard: "Panel",
    explore: "Explore",
    shareText: "Mioseg QR: {{title}}",
    untitled: "Mioseg QR bez nazwy",
    qrxFallback: "Mioseg QR w mioseg qr",
    loginRequired: "Najpierw się zaloguj, aby zobaczyć swoje Mioseg QR.",
    copyFailed: "Nie udało się skopiować linku.",
    deleteConfirm: "Czy na pewno chcesz usunąć ten Mioseg QR?\n\n{{title}}\n\nMioseg QR zostanie usunięty z Twojego konta.",
    sessionExpired: "Sesja wygasła. Zaloguj się ponownie.",
    deleteFailed: "Nie udało się usunąć Mioseg QR.",
    removeSavedConfirm: "Czy chcesz usunąć ten zapisany Mioseg QR?\n\n{{title}}",
    loginAgain: "Zaloguj się ponownie.",
    removeFailed: "Nie udało się usunąć Mioseg QR.",
    ownQrx: "Moje Mioseg QR",
    ...
    savedText: "Wszystkie obserwowane Mioseg QR. Zmiany są automatycznie synchronizowane z aplikacją.",
    myQrx: "Moje Mioseg QR",
    heroText: "Zarządzaj własnymi i zapisanymi Mioseg QR wygodnie w przeglądarce.",
    create: "Utwórz Mioseg QR",
    backDashboard: "Wróć do panelu",
    loading: "Ładowanie ...",
    count: "{{filtered}} z {{total}} wpisów",
    search: "Szukaj Mioseg QR",
    searchPlaceholder: "Szukaj tytułu, firmy, miejsca lub kategorii …",
    clearSearch: "Wyczyść wyszukiwanie",
    noneOwn: "Nie utworzono jeszcze Mioseg QR",
    noneSaved: "Nie zapisano jeszcze Mioseg QR",
    noneOwnText: "Po utworzeniu pierwszego Mioseg QR pojawi się on tutaj.",
    noneSavedText: "Gdy zaczniesz obserwować Mioseg QR, pojawi się tutaj automatycznie.",
    openExplore: "Otwórz Explore",
    noMatch: "Nie znaleziono pasującego Mioseg QR",
    noMatchText: "Sprawdź wyszukiwane hasło lub wyczyść wyszukiwanie.",
    loadingQrx: "Ładowanie Mioseg QR …",
    businessBadge: "🏢 Business Mioseg QR",
    normalBadge: "⌗ Zwykły Mioseg QR",
    created: "Utworzono",
    views: "Wyświetlenia Mioseg QR",
  ...
  ar: {
    navLabel: "تنقل Mioseg QR",
    dashboard: "لوحة التحكم",
    explore: "Explore",
    shareText: "Mioseg QR: {{title}}",
    untitled: "Mioseg QR بلا عنوان",
    qrxFallback: "Mioseg QR على mioseg qr",
    loginRequired: "يرجى تسجيل الدخول أولًا لعرض Mioseg QR الخاصة بك.",
    copyFailed: "تعذر نسخ الرابط.",
    deleteConfirm: "هل تريد حقًا حذف Mioseg QR هذا؟\n\n{{title}}\n\nستتم إزالته من حسابك.",
    sessionExpired: "انتهت جلستك. يرجى تسجيل الدخول مرة أخرى.",
    deleteFailed: "تعذر حذف Mioseg QR.",
    removeSavedConfirm: "هل تريد إزالة Mioseg QR المحفوظ هذا؟\n\n{{title}}",
    loginAgain: "يرجى تسجيل الدخول مرة أخرى.",
    removeFailed: "تعذر إزالة Mioseg QR.",
    ownQrx: "Mioseg QR الخاصة بي",
    ...
    savedText: "كل Mioseg QR التي تتابعها. تتم مزامنة التغييرات تلقائيًا مع التطبيق.",
    myQrx: "Mioseg QR الخاصة بي",
    heroText: "أدر Mioseg QR الخاصة بك والمحفوظة بسهولة من المتصفح.",
    create: "إنشاء Mioseg QR",
    backDashboard: "العودة إلى لوحة التحكم",
    loading: "جارٍ التحميل ...",
    count: "{{filtered}} من {{total}} عناصر",
    search: "بحث Mioseg QR",
    searchPlaceholder: "ابحث بالعنوان أو الشركة أو الموقع أو الفئة …",
    clearSearch: "مسح البحث",
    noneOwn: "لم يتم إنشاء Mioseg QR بعد",
    noneSaved: "لا توجد Mioseg QR محفوظة بعد",
    noneOwnText: "عند إنشاء أول Mioseg QR سيظهر هنا.",
    noneSavedText: "عند متابعة Mioseg QR سيظهر هنا تلقائيًا.",
    openExplore: "فتح Explore",
    noMatch: "لم يتم العثور على Mioseg QR مطابق",
    noMatchText: "تحقق من عبارة البحث أو امسح البحث.",
    loadingQrx: "جارٍ تحميل Mioseg QR …",
    businessBadge: "🏢 Business Mioseg QR",
    normalBadge: "⌗ Mioseg QR عادية",
    created: "تم الإنشاء",
    views: "مشاهدات Mioseg QR",
    followers: "المتابعون",
  ...
  fr: {
    navLabel: "Navigation Mioseg QR",
    dashboard: "Tableau de bord",
    explore: "Explore",
    shareText: "Mioseg QR : {{title}}",
    untitled: "Mioseg QR sans titre",
    qrxFallback: "Mioseg QR sur mioseg qr",
    loginRequired: "Connectez-vous pour voir vos Mioseg QR.",
    copyFailed: "Le lien n’a pas pu être copié.",
    deleteConfirm: "Voulez-vous vraiment supprimer ce Mioseg QR ?\n\n{{title}}\n\nLe Mioseg QR sera supprimé de votre compte.",
    sessionExpired: "Votre session a expiré. Veuillez vous reconnecter.",
    deleteFailed: "Le Mioseg QR n’a pas pu être supprimé.",
    removeSavedConfirm: "Voulez-vous retirer ce Mioseg QR enregistré ?\n\n{{title}}",
    loginAgain: "Veuillez vous reconnecter.",
    removeFailed: "Le Mioseg QR n’a pas pu être retiré.",
    ownQrx: "Mes Mioseg QR",
    ...
    savedText: "Tous les Mioseg QR que vous suivez. Les modifications sont automatiquement synchronisées avec l’application.",
    myQrx: "Mes Mioseg QR",
    heroText: "Gérez facilement vos Mioseg QR et ceux enregistrés dans le navigateur.",
    create: "Créer un Mioseg QR",
    backDashboard: "Retour au tableau de bord",
    loading: "Chargement ...",
    count: "{{filtered}} sur {{total}} éléments",
    search: "Rechercher un Mioseg QR",
    searchPlaceholder: "Rechercher par titre, entreprise, lieu ou catégorie …",
    clearSearch: "Effacer la recherche",
    noneOwn: "Aucun Mioseg QR créé",
    noneSaved: "Aucun Mioseg QR enregistré",
    noneOwnText: "Après avoir créé votre premier Mioseg QR, il apparaîtra ici.",
    noneSavedText: "Lorsque vous suivez un Mioseg QR, il apparaît automatiquement ici.",
    openExplore: "Ouvrir Explore",
    noMatch: "Aucun Mioseg QR correspondant",
    noMatchText: "Vérifiez le terme recherché ou effacez la recherche.",
    loadingQrx: "Chargement des Mioseg QR …",
    businessBadge: "🏢 Business Mioseg QR",
    normalBadge: "⌗ Mioseg QR normal",
    created: "Créé",
    views: "Vues Mioseg QR",
    followers: "Abonnés",
  ...
  es: {
    navLabel: "Navegación Mioseg QR",
    dashboard: "Panel",
    explore: "Explore",
    shareText: "Mioseg QR: {{title}}",
    untitled: "Mioseg QR sin título",
    qrxFallback: "Mioseg QR en mioseg qr",
    loginRequired: "Inicia sesión para ver tus Mioseg QR.",
    copyFailed: "No se pudo copiar el enlace.",
    deleteConfirm: "¿Quieres eliminar realmente este Mioseg QR?\n\n{{title}}\n\nEl Mioseg QR se eliminará de tu cuenta.",
    sessionExpired: "Tu sesión ha caducado. Vuelve a iniciar sesión.",
    deleteFailed: "No se pudo eliminar el Mioseg QR.",
    removeSavedConfirm: "¿Quieres quitar este Mioseg QR guardado?\n\n{{title}}",
    loginAgain: "Vuelve a iniciar sesión.",
    removeFailed: "No se pudo quitar el Mioseg QR.",
    ownQrx: "Mis Mioseg QR",
    ...
    savedText: "Todos los Mioseg QR que sigues. Los cambios se sincronizan automáticamente con la app.",
    myQrx: "Mis Mioseg QR",
    heroText: "Gestiona tus Mioseg QR propios y guardados cómodamente en el navegador.",
    create: "Crear Mioseg QR",
    backDashboard: "Volver al panel",
    loading: "Cargando ...",
    count: "{{filtered}} de {{total}} elementos",
    search: "Buscar Mioseg QR",
    searchPlaceholder: "Buscar por título, empresa, lugar o categoría …",
    clearSearch: "Borrar búsqueda",
    noneOwn: "Aún no hay Mioseg QR creados",
    noneSaved: "Aún no hay Mioseg QR guardados",
    noneOwnText: "Cuando crees tu primer Mioseg QR aparecerá aquí.",
    noneSavedText: "Cuando sigas un Mioseg QR aparecerá aquí automáticamente.",
    openExplore: "Abrir Explore",
    noMatch: "No se encontró ningún Mioseg QR",
    noMatchText: "Comprueba el término o borra la búsqueda.",
    loadingQrx: "Cargando Mioseg QR …",
    businessBadge: "🏢 Business Mioseg QR",
    normalBadge: "⌗ Mioseg QR normal",
    created: "Creado",
    views: "Vistas de Mioseg QR",
  ...
  it: {
    navLabel: "Navigazione Mioseg QR",
    dashboard: "Dashboard",
    explore: "Explore",
    shareText: "Mioseg QR: {{title}}",
    untitled: "Mioseg QR senza titolo",
    qrxFallback: "Mioseg QR su mioseg qr",
    loginRequired: "Accedi per vedere i tuoi Mioseg QR.",
    copyFailed: "Impossibile copiare il link.",
    deleteConfirm: "Vuoi davvero eliminare questo Mioseg QR?\n\n{{title}}\n\nIl Mioseg QR verrà rimosso dal tuo account.",
    sessionExpired: "La sessione è scaduta. Accedi di nuovo.",
    deleteFailed: "Impossibile eliminare il Mioseg QR.",
    removeSavedConfirm: "Vuoi rimuovere questo Mioseg QR salvato?\n\n{{title}}",
    loginAgain: "Accedi di nuovo.",
    removeFailed: "Impossibile rimuovere il Mioseg QR.",
    ownQrx: "I miei Mioseg QR",
    ...
    savedText: "Tutti i Mioseg QR che segui. Le modifiche vengono sincronizzate automaticamente con l’app.",
    myQrx: "I miei Mioseg QR",
    heroText: "Gestisci comodamente dal browser i tuoi Mioseg QR e quelli salvati.",
    create: "Crea Mioseg QR",
    backDashboard: "Torna alla dashboard",
    loading: "Caricamento ...",
    count: "{{filtered}} di {{total}} elementi",
    search: "Cerca Mioseg QR",
    searchPlaceholder: "Cerca titolo, azienda, luogo o categoria …",
    clearSearch: "Cancella ricerca",
    noneOwn: "Nessun Mioseg QR creato",
    noneSaved: "Nessun Mioseg QR salvato",
    noneOwnText: "Quando crei il tuo primo Mioseg QR apparirà qui.",
    noneSavedText: "Quando segui un Mioseg QR apparirà automaticamente qui.",
    openExplore: "Apri Explore",
    noMatch: "Nessun Mioseg QR corrispondente",
    noMatchText: "Controlla il termine di ricerca o cancella la ricerca.",
    loadingQrx: "Caricamento Mioseg QR …",
    businessBadge: "🏢 Business Mioseg QR",
    normalBadge: "⌗ Mioseg QR normale",
    created: "Creato",
    views: "Visualizzazioni Mioseg QR",
    followers: "Follower",
...
function getQrxTitle(entry: QrxEntry, fallback = "Unbenannter Mioseg QR") {
  return (
    entry.company_name?.trim() || entry.title?.trim() || fallback
  );
}

function getQrxText(entry: QrxEntry, fallback = "Mioseg QR auf mioseg qr") {
  return (
    entry.description?.trim() ||
    entry.location_name?.trim() ||
    "Mioseg QR auf mioseg qr"
  );
}
...
export default function DashboardQrxPage() {
  ...
  async function loadMediaAnalyticsForOwnQrx(items: QrxEntry[]) {
    ...
    const results = await Promise.all(
      items.map(async (item) => {
        ...
        if (error) {
          console.warn(
            `Media Analytics konnten für Mioseg QR ${item.id} nicht geladen werden:`,
            error,
          );
          return null;
        }
  ...
  async function handleDeleteOwn(entry: QrxEntry) {
    ...
    try {
      ...
      console.error("Mioseg QR DELETE ERROR", error);
      const message =
