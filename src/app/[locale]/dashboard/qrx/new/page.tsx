...
const QR_FORM_TEXT = {
  de: {
    dashboard: "Dashboard",
    myQrx: "Meine Mioseg QR",
    createKicker: "Mioseg QR erstellen",
    newTitle: "Neuen Mioseg QR erstellen",
    createHero: "Erstelle deinen Mioseg QR inklusive Logo, Coverbild, Galerie-Bildern, Dateien/PDFs, Standort, Passwortschutz und Credit-Prüfung.",
    backMyQrx: "Zurück zu Meine Mioseg QR",
    baseData: "Basisdaten",
    baseHint: "Wähle den Typ und trage die wichtigsten Informationen ein.",
    businessQrx: "Business Mioseg QR",
    normalQrx: "Normaler Mioseg QR",
    ...
    firstNormalFree: "Dieser normale Mioseg QR ist kostenlos, weil es dein erster normaler Mioseg QR ist.",
    costs: "kostet",
    ...
    logo: "Logo",
    logoHint: "Optional: Lade ein Logo hoch. Es wird später in deinem Mioseg QR angezeigt.",
    ...
    delete: "Löschen",
    collection: "Sammlung",
    collectionHint: "Verknüpfe weitere eigenständige Mioseg QR, zum Beispiel Produkte, Referenzen oder Projekte.",
    ...
    location: "Standort",
    locationHint: "Lege fest, ob dieser Mioseg QR ohne Standort gespeichert wird, den aktuellen Standort nutzt oder manuelle Koordinaten bekommt.",
    ...
    contactHint: "Diese Angaben erscheinen später als Buttons in der Mioseg QR Webansicht.",
    phone: "Telefon",
    website: "Webseite",
    email: "E-Mail",
    ...
    galleryHint: "Optional: Lade direkt Bilder hoch, die später in deinem Mioseg QR erscheinen.",
    ...
    verificationIntro: "Mit einer Verifizierung zeigst du Besuchern, dass Angaben und Nachweise zu diesem Mioseg QR geprüft wurden.",
    ...
    badgeText: "Nach erfolgreicher Prüfung erscheint ein dezentes Verifiziert-Abzeichen direkt am Mioseg QR.",
    privateDocs: "Nachweise bleiben privat",
    privateDocsText: "Hochgeladene Nachweise dienen nur der Prüfung und werden nicht öffentlich im Mioseg QR angezeigt.",
    ...
    passwordProtection: "Mioseg QR mit Passwort schützen",
    passwordHint: "Wenn aktiviert, müssen Besucher vor dem Öffnen dieses Mioseg QR ein Passwort eingeben.",
    password: "Passwort *",
    repeatPassword: "Passwort wiederholen *",
    selected: "Ausgewählt",
    storageCredits: "Speicher-Credits",
    storageHint: "Für den ausgewählten Speicher werden voraussichtlich zusätzliche Credits benötigt. Das Kontingent bleibt diesem Mioseg QR erhalten, auch wenn später Dateien gelöscht werden.",
    ...
    createQrx: "Mioseg QR erstellen",
    editKicker: "Mioseg QR bearbeiten",
    editTitle: "Mioseg QR bearbeiten",
    editHero: "Bearbeite die Basisdaten deines Mioseg QR, verwalte den Passwortschutz und beantrage für Business Mioseg QR die Verifizierung.",
    openQrx: "Mioseg QR öffnen",
    ...
    creditsLoadFailed: "Credits und Mioseg QR-Kosten konnten nicht geladen werden.",
    ...
    verificationBusinessOnly: "Eine Verifizierung ist nur für Business Mioseg QR möglich.",
    verificationProofRequired: "Bitte lade für die Verifizierung ein Dokument oder Bild hoch.",
    pricingStillLoading: "Credits und Mioseg QR-Kosten werden noch geladen. Bitte versuche es gleich erneut.",
    draftRestored: "Dein Mioseg QR Entwurf wurde wiederhergestellt. Bitte wähle Logo, Cover, Galerie-Bilder, Dateien/PDFs und Verifizierungsnachweise bei Bedarf erneut aus.",
    save: "Mioseg QR speichern",
    saving: "Speichert …",
    saved: "Mioseg QR wurde gespeichert.",
    savedMedia: "Mioseg QR und Medien wurden gespeichert.",
    media: "Bilder & Medien",
    ...
    verificationSubmitted: "Verifizierungsantrag wurde eingereicht. Dein Mioseg QR wird nun geprüft.",
    pending: "In Prüfung",
    ...
    onlyBusinessVerify: "Nur Business Mioseg QR können verifiziert werden.",
    alreadyVerification: "Für diesen Mioseg QR liegt bereits ein Verifizierungsantrag vor.",
    ...
    storageQuotaHint: "{{free}} MB sind pro Mioseg QR inklusive. Danach kostet jedes weitere Paket mit {{pack}} MB genau 1 Credit.",
    quotaAfterCreation: "Kontingent nach Erstellung",
    totalCosts: "Gesamtkosten",
    qrxCreation: "Mioseg QR Erstellung",
    totalLabel: "Gesamt",
    ...
    createFailed: "Mioseg QR konnte nicht erstellt werden.",
  },
  en: {
    dashboard: "Dashboard",
    myQrx: "My Mioseg QR",
    createKicker: "Create Mioseg QR",
    newTitle: "Create a new Mioseg QR",
    createHero: "Create your Mioseg QR with logo, cover image, gallery images, files/PDFs, location, password protection and Credit check.",
    backMyQrx: "Back to My Mioseg QR",
    baseData: "Basic data",
    ...
    firstNormalFree: "This normal Mioseg QR is free because it is your first normal Mioseg QR.",
    costs: "costs",
    ...
    logo: "Logo",
    logoHint: "Optional: Upload a logo. It will later be shown in your Mioseg QR.",
    ...
    collectionHint: "Link additional standalone Mioseg QR, such as products, references or projects.",
    ...
    location: "Location",
    locationHint: "Choose whether this Mioseg QR is saved without a location, uses your current location or manual coordinates.",
    ...
    contactHint: "These details later appear as buttons in the Mioseg QR web view.",
    phone: "Phone",
    website: "Website",
    email: "Email",
    navigation: "Navigation",
    ...
    galleryHint: "Optional: Upload images now that will later appear in your Mioseg QR.",
    ...
    verificationIntro: "Verification shows visitors that information and evidence for this Mioseg QR have been reviewed.",
    ...
    badgeText: "After successful review, a subtle verified badge appears directly on the Mioseg QR.",
    privateDocs: "Evidence stays private",
    privateDocsText: "Uploaded evidence is used only for review and is not displayed publicly in the Mioseg QR.",
    ...
    passwordProtection: "Protect Mioseg QR with password",
    passwordHint: "When enabled, visitors must enter a password before opening this Mioseg QR.",
    password: "Password *",
    repeatPassword: "Repeat password *",
    selected: "Selected",
    storageCredits: "Storage Credits",
    storageHint: "Additional Credits may be required for the selected storage. The purchased allowance remains assigned to this Mioseg QR even if files are deleted later.",
    ...
    createQrx: "Create Mioseg QR",
    editKicker: "Edit Mioseg QR",
    editTitle: "Edit Mioseg QR",
    editHero: "Edit the basic data of your Mioseg QR, manage password protection and request verification for Business Mioseg QR.",
    openQrx: "Open Mioseg QR",
    ...
    creditsLoadFailed: "Credits and Mioseg QR costs could not be loaded.",
    ...
    verificationBusinessOnly: "Verification is only available for Business Mioseg QR.",
    verificationProofRequired: "Please upload a document or image for verification.",
    pricingStillLoading: "Credits and Mioseg QR costs are still loading. Please try again shortly.",
    draftRestored: "Your Mioseg QR draft was restored. Please select logo, cover, gallery images, files/PDFs and verification evidence again if needed.",
    save: "Save Mioseg QR",
    saving: "Saving …",
    saved: "Mioseg QR saved.",
    savedMedia: "Mioseg QR and media saved.",
    media: "Images & media",
    ...
    verificationSubmitted: "Verification request submitted. Your Mioseg QR will now be reviewed.",
    ...
    onlyBusinessVerify: "Only Business Mioseg QR can be verified.",
    alreadyVerification: "A verification request already exists for this Mioseg QR.",
    ...
    storageQuotaHint: "{{free}} MB are included per Mioseg QR. Each additional {{pack}} MB package costs exactly 1 Credit.",
    quotaAfterCreation: "Allowance after creation",
    totalCosts: "Total cost",
    qrxCreation: "Mioseg QR creation",
    totalLabel: "Total",
    ...
    coverZoom: "Zoom",
    coverCenter: "Center",
    createFailed: "Mioseg QR could not be created.",
  },
  tr: {
    dashboard: "Kontrol paneli",
    myQrx: "Mioseg QR'lerim",
    createKicker: "Mioseg QR oluştur",
    newTitle: "Yeni Mioseg QR oluştur",
    createHero: "Logo, kapak görseli, galeri, dosya/PDF, konum, şifre koruması ve Credit kontrolüyle Mioseg QR oluştur.",
    backMyQrx: "Mioseg QR'lerime dön",
    ...
    firstNormalFree: "Bu normal Mioseg QR ilk normal Mioseg QR'in olduğu için ücretsiz.",
    costs: "maliyeti",
    ...
    logo: "Logo",
    logoHint: "İsteğe bağlı: Logo yükle. Daha sonra Mioseg QR'inde gösterilir.",
    chooseLogo: "Logo seç",
    cover: "Kapak görseli",
    ...
    collectionHint: "Ürün, referans veya proje gibi başka bağımsız Mioseg QR'leri bağla.",
    ...
    location: "Konum",
    locationHint: "Bu Mioseg QR'in konumsuz, mevcut konumla veya manuel koordinatlarla kaydedilmesini seç.",
    ...
    contactHint: "Bu bilgiler daha sonra Mioseg QR web görünümünde butonlar olarak görünür.",
    phone: "Telefon",
    website: "Web sitesi",
    email: "E-posta",
    ...
    galleryHint: "İsteğe bağlı: Mioseg QR'inde görünecek görselleri şimdi yükle.",
    ...
    verificationIntro: "Doğrulama, ziyaretçilere bu Mioseg QR'in bilgilerinin ve belgelerinin incelendiğini gösterir.",
    ...
    badgeText: "Başarılı incelemeden sonra Mioseg QR üzerinde sade bir doğrulandı rozeti görünür.",
    privateDocs: "Belgeler gizli kalır",
    privateDocsText: "Yüklenen belgeler yalnızca inceleme için kullanılır ve Mioseg QR'te herkese gösterilmez.",
    ...
    passwordProtection: "Mioseg QR’i şifreyle koru",
    passwordHint: "Etkinleştirildiğinde ziyaretçiler Mioseg QR'i açmadan önce şifre girmelidir.",
    password: "Şifre *",
    repeatPassword: "Şifreyi tekrarla *",
    selected: "Seçildi",
    storageCredits: "Depolama Credits",
    storageHint: "Seçilen depolama için ek Credits gerekebilir. Dosyalar daha sonra silinse bile satın alınan kota bu Mioseg QR'e bağlı kalır.",
    ...
    createQrx: "Mioseg QR oluştur",
    editKicker: "Mioseg QR düzenle",
    editTitle: "Mioseg QR düzenle",
    editHero: "Mioseg QR'in temel bilgilerini düzenle, şifre korumasını yönet ve Business Mioseg QR için doğrulama iste.",
    openQrx: "Mioseg QR'i aç",
    ...
    creditsLoadFailed: "Credits ve Mioseg QR maliyetleri yüklenemedi.",
    ...
    verificationBusinessOnly: "Doğrulama yalnızca Business Mioseg QR için kullanılabilir.",
    verificationProofRequired: "Doğrulama için belge veya görsel yükle.",
    pricingStillLoading: "Credits ve Mioseg QR maliyetleri hâlâ yükleniyor. Kısa süre sonra tekrar dene.",
    draftRestored: "Mioseg QR taslağın geri yüklendi. Gerekirse logo, kapak, galeri, dosya/PDF ve doğrulama belgesini yeniden seç.",
    save: "Mioseg QR'i kaydet",
    saving: "Kaydediliyor …",
    saved: "Mioseg QR kaydedildi.",
    savedMedia: "Mioseg QR ve medya kaydedildi.",
    ...
    verificationSubmitted: "Doğrulama isteği gönderildi. Mioseg QR'in şimdi incelenecek.",
    pending: "İnceleniyor",
    ...
    onlyBusinessVerify: "Yalnızca Business Mioseg QR doğrulanabilir.",
    alreadyVerification: "Bu Mioseg QR için zaten bir doğrulama isteği var.",
    ...
    storageQuotaHint: "Her Mioseg QR için {{free}} MB dahildir. Sonraki her {{pack}} MB paket tam 1 Credit tutar.",
    quotaAfterCreation: "Oluşturma sonrası kota",
    totalCosts: "Toplam maliyet",
    qrxCreation: "Mioseg QR oluşturma",
    totalLabel: "Toplam",
    ...
    coverCenter: "Ortala",
    createFailed: "Mioseg QR oluşturulamadı.",
  },
  pl: {
    dashboard: "Panel",
    myQrx: "Moje Mioseg QR",
    createKicker: "Utwórz Mioseg QR",
    newTitle: "Utwórz nowy Mioseg QR",
    createHero: "Utwórz Mioseg QR z logo, okładką, galerią, plikami/PDF, lokalizacją, ochroną hasłem i kontrolą Credits.",
    backMyQrx: "Wróć do Moich Mioseg QR",
    baseData: "Dane podstawowe",
    baseHint: "Wybierz typ i podaj najważniejsze informacje.",
    businessQrx: "Business Mioseg QR",
    normalQrx: "Zwykły Mioseg QR",
    ...
    firstNormalFree: "Ten zwykły Mioseg QR jest bezpłatny, ponieważ to Twój pierwszy zwykły Mioseg QR.",
    costs: "kosztuje",
    ...
    logo: "Logo",
    logoHint: "Opcjonalnie: prześlij logo. Będzie później widoczne w Mioseg QR.",
    ...
    delete: "Usuń",
    collection: "Kolekcja",
    collectionHint: "Połącz dodatkowe niezależne Mioseg QR, np. produkty, referencje lub projekty.",
    ...
    contactHint: "Te dane pojawią się później jako przyciski w widoku Mioseg QR.",
    phone: "Telefon",
    ...
    gallery: "Galeria",
    galleryHint: "Opcjonalnie: od razu prześlij obrazy, które będą widoczne w Mioseg QR.",
    ...
    verificationIntro: "Weryfikacja pokazuje odwiedzającym, że dane i dokumenty tego Mioseg QR zostały sprawdzone.",
    ...
    badgeText: "Po pomyślnej kontroli na Mioseg QR pojawia się dyskretna odznaka weryfikacji.",
    privateDocs: "Dokumenty pozostają prywatne",
    privateDocsText: "Przesłane dokumenty służą tylko do kontroli i nie są publicznie wyświetlane w Mioseg QR.",
    ...
    passwordProtection: "Chroń Mioseg QR hasłem",
    passwordHint: "Po włączeniu odwiedzający muszą podać hasło przed otwarciem Mioseg QR.",
    password: "Hasło *",
    repeatPassword: "Powtórz hasło *",
    selected: "Wybrano",
    storageCredits: "Credits za pamięć",
    storageHint: "Wybrana pamięć może wymagać dodatkowych Credits. Zakupiony limit pozostaje przy Mioseg QR nawet po późniejszym usunięciu plików.",
    ...
    createQrx: "Utwórz Mioseg QR",
    editKicker: "Edytuj Mioseg QR",
    editTitle: "Edytuj Mioseg QR",
    editHero: "Edytuj dane podstawowe Mioseg QR, zarządzaj ochroną hasłem i poproś o weryfikację Business Mioseg QR.",
    openQrx: "Otwórz Mioseg QR",
    ...
    creditsLoadFailed: "Nie udało się wczytać Credits i kosztów Mioseg QR.",
    ...
    verificationBusinessOnly: "Weryfikacja jest dostępna tylko dla Business Mioseg QR.",
    verificationProofRequired: "Prześlij dokument lub obraz do weryfikacji.",
    pricingStillLoading: "Credits i koszty Mioseg QR nadal się ładują. Spróbuj ponownie za chwilę.",
    draftRestored: "Przywrócono szkic Mioseg QR. W razie potrzeby ponownie wybierz logo, okładkę, galerię, pliki/PDF i dokumenty weryfikacyjne.",
    save: "Zapisz Mioseg QR",
    saving: "Zapisywanie …",
    saved: "Mioseg QR zapisany.",
    savedMedia: "Mioseg QR i media zapisane.",
    ...
    verificationSubmitted: "Wniosek o weryfikację został wysłany. Mioseg QR zostanie teraz sprawdzony.",
    ...
    onlyBusinessVerify: "Weryfikować można tylko Business Mioseg QR.",
    alreadyVerification: "Dla tego Mioseg QR istnieje już wniosek o weryfikację.",
    ...
    storageQuotaHint: "Każdy Mioseg QR zawiera {{free}} MB. Każdy kolejny pakiet {{pack}} MB kosztuje dokładnie 1 Credit.",
    quotaAfterCreation: "Limit po utworzeniu",
    totalCosts: "Łączny koszt",
    qrxCreation: "Utworzenie Mioseg QR",
    totalLabel: "Razem",
    ...
    createFailed: "Nie udało się utworzyć Mioseg QR.",
  },
  ar: {
    dashboard: "لوحة التحكم",
    myQrx: "Mioseg QR الخاصة بي",
    createKicker: "إنشاء Mioseg QR",
    newTitle: "إنشاء Mioseg QR جديد",
    createHero: "أنشئ Mioseg QR مع الشعار وصورة الغلاف والمعرض والملفات/PDF والموقع وحماية كلمة المرور وفحص Credits.",
    backMyQrx: "العودة إلى Mioseg QR الخاصة بي",
    baseData: "البيانات الأساسية",
    baseHint: "اختر النوع وأدخل أهم المعلومات.",
    businessQrx: "Business Mioseg QR",
    normalQrx: "Mioseg QR عادي",
    ...
    firstNormalFree: "Mioseg QR العادي هذا مجاني لأنه أول Mioseg QR عادي لك.",
    costs: "يكلف",
    ...
    logo: "الشعار",
    logoHint: "اختياري: حمّل شعارًا ليظهر لاحقًا في Mioseg QR.",
    ...
    delete: "حذف",
    collection: "المجموعة",
    collectionHint: "اربط Mioseg QR مستقلة أخرى مثل المنتجات أو المراجع أو المشاريع.",
    ...
    location: "الموقع",
    locationHint: "اختر حفظ Mioseg QR بدون موقع أو باستخدام موقعك الحالي أو إحداثيات يدوية.",
    ...
    contactHint: "تظهر هذه البيانات لاحقًا كأزرار في عرض Mioseg QR على الويب.",
    phone: "الهاتف",
    ...
    gallery: "صور المعرض",
    galleryHint: "اختياري: حمّل الآن الصور التي ستظهر لاحقًا في Mioseg QR.",
    ...
    verificationIntro: "يُظهر التوثيق للزوار أن معلومات ومستندات Mioseg QR هذا قد تمت مراجعتها.",
    ...
    badgeText: "بعد المراجعة الناجحة تظهر شارة توثيق بسيطة مباشرة على Mioseg QR.",
    privateDocs: "المستندات تبقى خاصة",
    privateDocsText: "تُستخدم المستندات المرفوعة للمراجعة فقط ولا تظهر للعامة في Mioseg QR.",
    ...
    passwordProtection: "حماية Mioseg QR بكلمة مرور",
    passwordHint: "عند التفعيل يجب على الزوار إدخال كلمة مرور قبل فتح Mioseg QR.",
    password: "كلمة المرور *",
    repeatPassword: "تكرار كلمة المرور *",
    selected: "المحدد",
    storageCredits: "Credits التخزين",
    storageHint: "قد تتطلب مساحة التخزين المحددة Credits إضافية. يبقى الحد المشتَرى مرتبطًا بـ Mioseg QR حتى بعد حذف الملفات لاحقًا.",
    ...
    createQrx: "إنشاء Mioseg QR",
    editKicker: "تعديل Mioseg QR",
    editTitle: "تعديل Mioseg QR",
    editHero: "عدّل البيانات الأساسية لـ Mioseg QR وأدر حماية كلمة المرور واطلب توثيق Business Mioseg QR.",
    openQrx: "فتح Mioseg QR",
    ...
    creditsLoadFailed: "تعذر تحميل Credits وتكاليف Mioseg QR.",
    ...
    verificationBusinessOnly: "التوثيق متاح فقط لـ Business Mioseg QR.",
    verificationProofRequired: "ارفع مستندًا أو صورة للتوثيق.",
    pricingStillLoading: "لا تزال Credits وتكاليف Mioseg QR قيد التحميل. حاول مرة أخرى بعد قليل.",
    draftRestored: "تمت استعادة مسودة Mioseg QR. أعد اختيار الشعار والغلاف والمعرض والملفات/PDF ومستندات التوثيق عند الحاجة.",
    save: "حفظ Mioseg QR",
    saving: "جارٍ الحفظ …",
    saved: "تم حفظ Mioseg QR.",
    savedMedia: "تم حفظ Mioseg QR والوسائط.",
    ...
    verificationSubmitted: "تم إرسال طلب التوثيق. سيجري الآن فحص Mioseg QR.",
    ...
    onlyBusinessVerify: "يمكن توثيق Business Mioseg QR فقط.",
    alreadyVerification: "يوجد بالفعل طلب توثيق لهذا Mioseg QR.",
    ...
    storageQuotaHint: "يتضمن كل Mioseg QR مساحة {{free}} MB. كل حزمة إضافية بحجم {{pack}} MB تكلف Credit واحدًا.",
    quotaAfterCreation: "الحصة بعد الإنشاء",
    totalCosts: "التكلفة الإجمالية",
    qrxCreation: "إنشاء Mioseg QR",
    totalLabel: "الإجمالي",
    ...
    coverZoom: "تكبير",
    coverCenter: "توسيط",
    createFailed: "تعذر إنشاء Mioseg QR.",
  },
  fr: {
    dashboard: "Tableau de bord",
    myQrx: "Mes Mioseg QR",
    createKicker: "Créer un Mioseg QR",
    newTitle: "Créer un nouveau Mioseg QR",
    createHero: "Créez votre Mioseg QR avec logo, couverture, galerie, fichiers/PDF, emplacement, protection par mot de passe et contrôle des Credits.",
    backMyQrx: "Retour à Mes Mioseg QR",
    baseData: "Données de base",
    baseHint: "Choisissez le type et saisissez les informations principales.",
    businessQrx: "Business Mioseg QR",
    normalQrx: "Mioseg QR normal",
    ...
    firstNormalFree: "Ce Mioseg QR normal est gratuit car il s’agit de votre premier Mioseg QR normal.",
    costs: "coûte",
    ...
    logo: "Logo",
    logoHint: "Facultatif : ajoutez un logo. Il sera affiché plus tard dans votre Mioseg QR.",
    ...
    delete: "Supprimer",
    collection: "Collection",
    collectionHint: "Reliez d’autres Mioseg QR autonomes, par exemple des produits, références ou projets.",
    ...
    locationHint: "Choisissez d’enregistrer ce Mioseg QR sans emplacement, avec votre position actuelle ou avec des coordonnées manuelles.",
    ...
    contactHint: "Ces informations apparaîtront ensuite sous forme de boutons dans la vue web Mioseg QR.",
    phone: "Téléphone",
    website: "Site web",
    email: "E-mail",
    navigation: "Navigation",
    ...
    galleryHint: "Facultatif : ajoutez directement des images qui apparaîtront dans votre Mioseg QR.",
    ...
    verificationIntro: "La vérification montre aux visiteurs que les informations et justificatifs de ce Mioseg QR ont été examinés.",
    ...
    badgeText: "Après validation, un badge discret apparaît directement sur le Mioseg QR.",
    privateDocs: "Les justificatifs restent privés",
    privateDocsText: "Les justificatifs servent uniquement au contrôle et ne sont pas affichés publiquement dans le Mioseg QR.",
    ...
    passwordProtection: "Protéger le Mioseg QR par mot de passe",
    passwordHint: "Si activé, les visiteurs doivent saisir un mot de passe avant d’ouvrir ce Mioseg QR.",
    password: "Mot de passe *",
    repeatPassword: "Répéter le mot de passe *",
    selected: "Sélectionné",
    storageCredits: "Credits de stockage",
    storageHint: "Le stockage sélectionné peut nécessiter des Credits supplémentaires. Le quota acheté reste attribué à ce Mioseg QR même si des fichiers sont supprimés ensuite.",
    ...
    createQrx: "Créer le Mioseg QR",
    editKicker: "Modifier Mioseg QR",
    editTitle: "Modifier Mioseg QR",
    editHero: "Modifiez les données de base, gérez la protection par mot de passe et demandez la vérification d’un Business Mioseg QR.",
    openQrx: "Ouvrir le Mioseg QR",
    ...
    creditsLoadFailed: "Les Credits et les coûts Mioseg QR n’ont pas pu être chargés.",
    ...
    verificationBusinessOnly: "La vérification est réservée aux Business Mioseg QR.",
    verificationProofRequired: "Ajoutez un document ou une image pour la vérification.",
    pricingStillLoading: "Les Credits et les coûts Mioseg QR sont encore en cours de chargement. Réessayez dans un instant.",
    draftRestored: "Votre brouillon Mioseg QR a été restauré. Sélectionnez de nouveau le logo, la couverture, la galerie, les fichiers/PDF et justificatifs si nécessaire.",
    save: "Enregistrer le Mioseg QR",
    saving: "Enregistrement …",
    saved: "Mioseg QR enregistré.",
    savedMedia: "Mioseg QR et médias enregistrés.",
    ...
    verificationSubmitted: "Demande de vérification envoyée. Votre Mioseg QR va être examiné.",
    ...
    onlyBusinessVerify: "Seuls les Business Mioseg QR peuvent être vérifiés.",
    alreadyVerification: "Une demande de vérification existe déjà pour ce Mioseg QR.",
    ...
    storageQuotaHint: "{{free}} Mo sont inclus par Mioseg QR. Chaque paquet supplémentaire de {{pack}} Mo coûte exactement 1 Credit.",
    quotaAfterCreation: "Quota après création",
    totalCosts: "Coût total",
    qrxCreation: "Création du Mioseg QR",
    totalLabel: "Total",
    ...
    coverZoom: "Zoom",
    coverCenter: "Centrer",
    createFailed: "Le Mioseg QR n’a pas pu être créé.",
  },
  es: {
    dashboard: "Panel",
    myQrx: "Mis Mioseg QR",
    createKicker: "Crear Mioseg QR",
    newTitle: "Crear nuevo Mioseg QR",
    createHero: "Crea tu Mioseg QR con logo, portada, galería, archivos/PDF, ubicación, protección con contraseña y comprobación de Credits.",
    backMyQrx: "Volver a Mis Mioseg QR",
    ...
    firstNormalFree: "Este Mioseg QR normal es gratuito porque es tu primer Mioseg QR normal.",
    costs: "cuesta",
    ...
    logo: "Logo",
    logoHint: "Opcional: sube un logo. Se mostrará más adelante en tu Mioseg QR.",
    ...
    collectionHint: "Vincula otros Mioseg QR independientes, como productos, referencias o proyectos.",
    ...
    location: "Ubicación",
    locationHint: "Elige guardar este Mioseg QR sin ubicación, con tu ubicación actual o con coordenadas manuales.",
    ...
    contactHint: "Estos datos aparecerán más tarde como botones en la vista web del Mioseg QR.",
    phone: "Teléfono",
    website: "Sitio web",
    ...
    galleryHint: "Opcional: sube directamente imágenes que aparecerán en tu Mioseg QR.",
    ...
    verificationIntro: "La verificación muestra a los visitantes que los datos y justificantes de este Mioseg QR han sido revisados.",
    ...
    badgeText: "Tras una revisión satisfactoria aparece una insignia discreta directamente en el Mioseg QR.",
    privateDocs: "Los justificantes siguen siendo privados",
    privateDocsText: "Los justificantes subidos solo se usan para la revisión y no se muestran públicamente en el Mioseg QR.",
    ...
    passwordProtection: "Proteger Mioseg QR con contraseña",
    passwordHint: "Si se activa, los visitantes deben introducir una contraseña antes de abrir este Mioseg QR.",
    password: "Contraseña *",
    repeatPassword: "Repetir contraseña *",
    selected: "Seleccionado",
    storageCredits: "Credits de almacenamiento",
    storageHint: "El almacenamiento seleccionado puede requerir Credits adicionales. La cuota comprada permanece asignada a este Mioseg QR aunque se eliminen archivos después.",
    ...
    createQrx: "Crear Mioseg QR",
    editKicker: "Editar Mioseg QR",
    editTitle: "Editar Mioseg QR",
    editHero: "Edita los datos básicos, gestiona la protección con contraseña y solicita la verificación de Business Mioseg QR.",
    openQrx: "Abrir Mioseg QR",
    ...
    creditsLoadFailed: "No se pudieron cargar los Credits ni los costes de Mioseg QR.",
    ...
    verificationBusinessOnly: "La verificación solo está disponible para Business Mioseg QR.",
    verificationProofRequired: "Sube un documento o imagen para la verificación.",
    pricingStillLoading: "Los Credits y costes de Mioseg QR aún se están cargando. Inténtalo de nuevo en un momento.",
    draftRestored: "Se ha restaurado tu borrador Mioseg QR. Vuelve a seleccionar logo, portada, galería, archivos/PDF y justificantes si es necesario.",
    save: "Guardar Mioseg QR",
    saving: "Guardando …",
    saved: "Mioseg QR guardado.",
    savedMedia: "Mioseg QR y medios guardados.",
    ...
    verificationSubmitted: "Solicitud de verificación enviada. Tu Mioseg QR será revisado ahora.",
    pending: "En revisión",
    ...
    onlyBusinessVerify: "Solo los Business Mioseg QR pueden verificarse.",
    alreadyVerification: "Ya existe una solicitud de verificación para este Mioseg QR.",
    ...
    storageQuotaHint: "Se incluyen {{free}} MB por Mioseg QR. Cada paquete adicional de {{pack}} MB cuesta exactamente 1 Credit.",
    quotaAfterCreation: "Cuota tras la creación",
    totalCosts: "Coste total",
    qrxCreation: "Creación de Mioseg QR",
    totalLabel: "Total",
    ...
    coverZoom: "Zoom",
    coverCenter: "Centrar",
    createFailed: "No se pudo crear el Mioseg QR.",
  },
  it: {
    dashboard: "Dashboard",
    myQrx: "I miei Mioseg QR",
    createKicker: "Crea Mioseg QR",
    newTitle: "Crea un nuovo Mioseg QR",
    createHero: "Crea il tuo Mioseg QR con logo, copertina, galleria, file/PDF, posizione, protezione con password e controllo Credits.",
    backMyQrx: "Torna a I miei Mioseg QR",
    baseData: "Dati di base",
    baseHint: "Scegli il tipo e inserisci le informazioni principali.",
    businessQrx: "Business Mioseg QR",
    normalQrx: "Mioseg QR normale",
    ...
    firstNormalFree: "Questo Mioseg QR normale è gratuito perché è il tuo primo Mioseg QR normale.",
    costs: "costa",
    ...
    logo: "Logo",
    logoHint: "Facoltativo: carica un logo. Verrà mostrato in seguito nel Mioseg QR.",
    ...
    collectionHint: "Collega altri Mioseg QR indipendenti, ad esempio prodotti, referenze o progetti.",
    ...
    location: "Posizione",
    locationHint: "Scegli se salvare il Mioseg QR senza posizione, con la posizione attuale o con coordinate manuali.",
    ...
    contactHint: "Questi dati appariranno come pulsanti nella vista web Mioseg QR.",
    phone: "Telefono",
    website: "Sito web",
    email: "E-mail",
    ...
    galleryHint: "Facoltativo: carica subito immagini che appariranno nel Mioseg QR.",
    ...
    verificationIntro: "La verifica mostra ai visitatori che informazioni e documenti di questo Mioseg QR sono stati controllati.",
    ...
    badgeText: "Dopo un controllo positivo compare un badge discreto direttamente sul Mioseg QR.",
    privateDocs: "I documenti restano privati",
    privateDocsText: "I documenti caricati servono solo per il controllo e non vengono mostrati pubblicamente nel Mioseg QR.",
    ...
    passwordProtection: "Proteggi Mioseg QR con password",
    passwordHint: "Se attivato, i visitatori devono inserire una password prima di aprire questo Mioseg QR.",
    password: "Password *",
    repeatPassword: "Ripeti password *",
    selected: "Selezionato",
    storageCredits: "Credits di archiviazione",
    storageHint: "Lo spazio selezionato può richiedere Credits aggiuntivi. La quota acquistata resta assegnata al Mioseg QR anche se i file vengono eliminati in seguito.",
    ...
    createQrx: "Crea Mioseg QR",
    editKicker: "Modifica Mioseg QR",
    editTitle: "Modifica Mioseg QR",
    editHero: "Modifica i dati di base, gestisci la protezione con password e richiedi la verifica per Business Mioseg QR.",
    openQrx: "Apri Mioseg QR",
    ...
    creditsLoadFailed: "Impossibile caricare Credits e costi Mioseg QR.",
    ...
    verificationBusinessOnly: "La verifica è disponibile solo per Business Mioseg QR.",
    verificationProofRequired: "Carica un documento o immagine per la verifica.",
    pricingStillLoading: "Credits e costi Mioseg QR sono ancora in caricamento. Riprova tra poco.",
    draftRestored: "La bozza Mioseg QR è stata ripristinata. Se necessario seleziona nuovamente logo, copertina, galleria, file/PDF e documenti di verifica.",
    save: "Salva Mioseg QR",
    saving: "Salvataggio …",
    saved: "Mioseg QR salvato.",
    savedMedia: "Mioseg QR e media salvati.",
    ...
    verificationSubmitted: "Richiesta di verifica inviata. Il tuo Mioseg QR verrà ora controllato.",
    pending: "In verifica",
    ...
    onlyBusinessVerify: "Solo i Business Mioseg QR possono essere verificati.",
    alreadyVerification: "Esiste già una richiesta di verifica per questo Mioseg QR.",
    ...
    storageQuotaHint: "Sono inclusi {{free}} MB per Mioseg QR. Ogni pacchetto aggiuntivo da {{pack}} MB costa esattamente 1 Credit.",
    quotaAfterCreation: "Quota dopo la creazione",
    totalCosts: "Costo totale",
    qrxCreation: "Creazione Mioseg QR",
    totalLabel: "Totale",
    ...
    coverZoom: "Zoom",
    coverCenter: "Centra",
    createFailed: "Impossibile creare il Mioseg QR.",
  },
} as const;
...
const QR_CREATE_RUNTIME = {
  de: {
    confirmSpend: "Bitte bestätige den Credit-Verbrauch, bevor der Mioseg QR erstellt wird.",
    createCost: "Mioseg QR-Erstellung: {{count}} Credits",
    ...
    created: "Mioseg QR wurde erstellt.",
    createdProtected: "Mioseg QR wurde erstellt und mit Passwort geschützt.",
    creditsDeducted: "{{count}} Credits wurden abgezogen.",
    firstFree: "Der erste normale Mioseg QR ist kostenlos.",
  ...
  en: {
    confirmSpend: "Please confirm the Credit charge before the Mioseg QR is created.",
    createCost: "Mioseg QR creation: {{count}} Credits",
    ...
    created: "Mioseg QR was created.",
    createdProtected: "Mioseg QR was created and password protected.",
    creditsDeducted: "{{count}} Credits were charged.",
    firstFree: "The first normal Mioseg QR is free.",
  ...
  tr: {
    confirmSpend: "Mioseg QR oluşturulmadan önce Credit kullanımını onayla.",
    createCost: "Mioseg QR oluşturma: {{count}} Credits",
    ...
    created: "Mioseg QR oluşturuldu.",
    createdProtected: "Mioseg QR oluşturuldu ve şifreyle korundu.",
    creditsDeducted: "{{count}} Credits düşüldü.",
    firstFree: "İlk normal Mioseg QR ücretsizdir.",
  ...
  pl: {
    confirmSpend: "Potwierdź wykorzystanie Credits przed utworzeniem Mioseg QR.",
    createCost: "Utworzenie Mioseg QR: {{count}} Credits",
    ...
    created: "Mioseg QR został utworzony.",
    createdProtected: "Mioseg QR został utworzony i zabezpieczony hasłem.",
    creditsDeducted: "Pobrano {{count}} Credits.",
    firstFree: "Pierwszy zwykły Mioseg QR jest bezpłatny.",
  ...
  ar: {
    confirmSpend: "يرجى تأكيد استخدام Credits قبل إنشاء Mioseg QR.",
    createCost: "إنشاء Mioseg QR: {{count}} Credits",
    ...
    created: "تم إنشاء Mioseg QR.",
    createdProtected: "تم إنشاء Mioseg QR وحمايته بكلمة مرور.",
    creditsDeducted: "تم خصم {{count}} Credits.",
    firstFree: "أول Mioseg QR عادي مجاني.",
  ...
  fr: {
    confirmSpend: "Confirmez l’utilisation des Credits avant la création du Mioseg QR.",
    createCost: "Création Mioseg QR : {{count}} Credits",
    ...
    created: "Mioseg QR créé.",
    createdProtected: "Mioseg QR créé et protégé par mot de passe.",
    creditsDeducted: "{{count}} Credits ont été débités.",
    firstFree: "Le premier Mioseg QR normal est gratuit.",
  ...
  es: {
    confirmSpend: "Confirma el uso de Credits antes de crear el Mioseg QR.",
    createCost: "Creación de Mioseg QR: {{count}} Credits",
    ...
    created: "Mioseg QR creado.",
    createdProtected: "Mioseg QR creado y protegido con contraseña.",
    creditsDeducted: "Se descontaron {{count}} Credits.",
    firstFree: "El primer Mioseg QR normal es gratuito.",
  ...
  it: {
    confirmSpend: "Conferma l’uso dei Credits prima di creare il Mioseg QR.",
    createCost: "Creazione Mioseg QR: {{count}} Credits",
    ...
    created: "Mioseg QR creato.",
    createdProtected: "Mioseg QR creato e protetto con password.",
    creditsDeducted: "Sono stati addebitati {{count}} Credits.",
    firstFree: "Il primo Mioseg QR normale è gratuito.",
...
export default function NewQrxPage() {
  ...
  const selectedStorageBytes = useMemo(() => {
    ...
    return galleryBytes + fileBytes;
  }, [galleryFiles, fileUploads]);
  ...
  useEffect(() => {
    ...
    try {
      ...
      console.warn(
        "Mioseg QR Entwurf konnte nicht wiederhergestellt werden:",
        restoreError,
      );
      try {
  ...
  useEffect(() => {
    ...
    draftSaveTimerRef.current = window.setTimeout(() => {
      ...
      try {
        ...
        console.warn(
          "Mioseg QR Entwurf konnte nicht gespeichert werden:",
          saveError,
        );
      }
    }, 350);
  ...
  async function loadCollectionCandidates() {
    ...
    try {
      ...
      console.warn("Mioseg QR Sammlung konnte nicht geladen werden:", error);
      setCollectionCandidates([]);
    } finally {
  ...
  async function deleteCreatedQrxIfNeeded(qrxId: string) {
    try {
      ...
      console.warn("Mioseg QR Cleanup nach Fehler fehlgeschlagen:", deleteError);
    }
  }
  ...
  function clearSavedDraft() {
    if (typeof window !== "undefined") {
      try {
        ...
        console.warn("Mioseg QR Entwurf konnte nicht gelöscht werden:", draftError);
      }
    }
        ...
        >
          ...
          >
            {pricingLoading || creationCostCredits == null ? (
              ...
              <>
                Dieser {isBusiness ? "Business Mioseg QR" : "normale Mioseg QR"} kostet{" "}
                ...
                <div style={{ display: "grid", gap: 12 }}>
                  <div style={coverPreviewViewportStyle}>
                    <canvas
                      ...
                      aria-label={ui.coverPreviewAlt}
                      style={coverPreviewCanvasStyle}
                    />
                  </div>
