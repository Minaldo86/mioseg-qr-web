...
const QR_VERIFY_STATUS_TEXT = {
  de: {
    ...
    verifiedText: "Dieser Business Mioseg QR ist verifiziert.",
    status: "Status",
  },
  en: {
    approved: "Approved",
    ...
    unknown: "Unknown",
    verified: "Verified",
    verifiedText: "This Business Mioseg QR is verified.",
    status: "Status",
  },
  tr: {
    approved: "Onaylandı",
    ...
    unknown: "Bilinmiyor",
    verified: "Doğrulandı",
    verifiedText: "Bu Business Mioseg QR doğrulandı.",
    status: "Durum",
  },
  pl: {
    ...
    verifiedText: "Ten Business Mioseg QR jest zweryfikowany.",
    status: "Status",
  },
  ar: {
    ...
    unknown: "غير معروف",
    verified: "موثّق",
    verifiedText: "تم توثيق Business Mioseg QR هذا.",
    status: "الحالة",
  },
  fr: {
    approved: "Approuvé",
    ...
    unknown: "Inconnu",
    verified: "Vérifié",
    verifiedText: "Ce Business Mioseg QR est vérifié.",
    status: "Statut",
  },
  es: {
    approved: "Aprobado",
    ...
    unknown: "Desconocido",
    verified: "Verificado",
    verifiedText: "Este Business Mioseg QR está verificado.",
    status: "Estado",
  },
  it: {
    approved: "Approvato",
    ...
    unknown: "Sconosciuto",
    verified: "Verificato",
    verifiedText: "Questo Business Mioseg QR è verificato.",
    status: "Stato",
  },
} as const;
...
const QR_EDIT_EXTRA_TEXT = {
  de: {
    loadFailed: "Mioseg QR konnte nicht geladen werden.",
    justNow: "Gerade eben",
    notFound: "Mioseg QR wurde nicht gefunden.",
    forbidden: "Du darfst diesen Mioseg QR nicht bearbeiten.",
    saveFailed: "Mioseg QR konnte nicht gespeichert werden.",
  ...
  en: {
    loadFailed: "Mioseg QR could not be loaded.",
    justNow: "Just now",
    notFound: "Mioseg QR was not found.",
    forbidden: "You are not allowed to edit this Mioseg QR.",
    saveFailed: "Mioseg QR could not be saved.",
    noNews: "No news yet.",
  ...
  tr: {
    loadFailed: "Mioseg QR yüklenemedi.",
    justNow: "Az önce",
    notFound: "Mioseg QR bulunamadı.",
    forbidden: "Bu Mioseg QR'i düzenleme iznin yok.",
    saveFailed: "Mioseg QR kaydedilemedi.",
  ...
  pl: {
    loadFailed: "Nie udało się wczytać Mioseg QR.",
    justNow: "Przed chwilą",
    notFound: "Nie znaleziono Mioseg QR.",
    forbidden: "Nie możesz edytować tego Mioseg QR.",
    saveFailed: "Nie udało się zapisać Mioseg QR.",
  ...
  ar: {
    loadFailed: "تعذر تحميل Mioseg QR.",
    justNow: "الآن",
    notFound: "لم يتم العثور على Mioseg QR.",
    forbidden: "لا يُسمح لك بتعديل هذا Mioseg QR.",
    saveFailed: "تعذر حفظ Mioseg QR.",
  ...
  fr: {
    loadFailed: "Le Mioseg QR n’a pas pu être chargé.",
    justNow: "À l’instant",
    notFound: "Le Mioseg QR est introuvable.",
    forbidden: "Vous n’êtes pas autorisé à modifier ce Mioseg QR.",
    saveFailed: "Le Mioseg QR n’a pas pu être enregistré.",
  ...
  es: {
    loadFailed: "No se pudo cargar el Mioseg QR.",
    justNow: "Ahora mismo",
    notFound: "No se encontró el Mioseg QR.",
    forbidden: "No tienes permiso para editar este Mioseg QR.",
    saveFailed: "No se pudo guardar el Mioseg QR.",
  ...
  it: {
    loadFailed: "Impossibile caricare il Mioseg QR.",
    justNow: "Proprio ora",
    notFound: "Mioseg QR non trovato.",
    forbidden: "Non sei autorizzato a modificare questo Mioseg QR.",
    saveFailed: "Impossibile salvare il Mioseg QR.",
...
export default function EditQrxPage() {
  ...
  async function saveCollection(userId: string) {
    if (!qrxId) throw new Error("Mioseg QR ID fehlt.");
  ...
  async function loadQrx() {
    ...
    try {
      if (!qrxId) {
        throw new Error("Mioseg QR ID fehlt.");
      }
  ...
  async function handleSubmitVerificationRequest() {
    ...
    try {
      ...
      if (isVerified) throw new Error("Dieser Mioseg QR ist bereits verifiziert.");
  ...
  return (
    <main className={styles.page}>
      ...
      <section style={panelStyle}>
        ...
        {loading ? <div style={loadingStyle}>{ui.locationLoading.replace(ui.location, "Mioseg QR")}</div> : null}
