...
const QR_MEDIA_TEXT = {
  de: {
    ...
    mediaTitle: "Mioseg QR Medien",
    missingId: "Mioseg QR ID fehlt.",
    ...
    removeConfirm: "Diesen Eintrag aus Mioseg QR Medien entfernen?",
    ...
    analyticsText: "Aufrufe, Öffnungen und Downloads deiner Mioseg QR-Medien. Automatisch geladene Vorschaubilder werden nicht als Bildaufruf gezählt.",
    ...
    gallery: "Galerie",
    galleryText: "Diese Bilder sind aktuell mit deinem Mioseg QR verknüpft.",
    entries: "{{count}} Einträge",
    noGallery: "Noch keine Galerie-Bilder vorhanden.",
    files: "Dateien",
    filesText: "Diese Dateien sind aktuell mit deinem Mioseg QR verknüpft.",
  ...
  en: {
    ...
    mediaTitle: "Mioseg QR media",
    missingId: "Mioseg QR ID is missing.",
    ...
    removeConfirm: "Remove this item from Mioseg QR media?",
    ...
    analyticsText: "Views, opens and downloads of your Mioseg QR media. Automatically loaded preview images are not counted as image views.",
    ...
    gallery: "Gallery",
    galleryText: "These images are currently linked to your Mioseg QR.",
    entries: "{{count}} entries",
    noGallery: "No gallery images yet.",
    files: "Files",
    filesText: "These files are currently linked to your Mioseg QR.",
  ...
  tr: {
    ...
    mediaTitle: "Mioseg QR medyası",
    missingId: "Mioseg QR kimliği eksik.",
    ...
    removeConfirm: "Bu öğeyi Mioseg QR medyasından kaldırmak istiyor musun?",
    ...
    analyticsText: "Mioseg QR medyanın görüntülenme, açılma ve indirilme verileri. Otomatik yüklenen önizlemeler görsel görüntüleme olarak sayılmaz.",
    ...
    gallery: "Galeri",
    galleryText: "Bu görseller şu anda Mioseg QR'inle bağlantılı.",
    entries: "{{count}} öğe",
    noGallery: "Henüz galeri görseli yok.",
    files: "Dosyalar",
    filesText: "Bu dosyalar şu anda Mioseg QR'inle bağlantılı.",
  ...
  pl: {
    ...
    mediaTitle: "Media Mioseg QR",
    missingId: "Brak ID Mioseg QR.",
    ...
    removeConfirm: "Usunąć ten element z mediów Mioseg QR?",
    ...
    analyticsText: "Wyświetlenia, otwarcia i pobrania mediów Mioseg QR. Automatycznie ładowane podglądy nie są liczone jako wyświetlenia obrazu.",
    ...
    gallery: "Galeria",
    galleryText: "Te obrazy są obecnie powiązane z Twoim Mioseg QR.",
    entries: "{{count}} elementów",
    noGallery: "Brak obrazów w galerii.",
    files: "Pliki",
    filesText: "Te pliki są obecnie powiązane z Twoim Mioseg QR.",
    noFiles: "Brak plików.",
  ...
  ar: {
    ...
    mediaTitle: "وسائط Mioseg QR",
    missingId: "معرّف Mioseg QR مفقود.",
    login: "يرجى تسجيل الدخول أولًا.",
    notFound: "لم يتم العثور على Mioseg QR.",
    forbidden: "لا يُسمح لك بتعديل Mioseg QR هذا.",
    analyticsLoadFailed: "تعذر تحميل تحليلات الوسائط.",
    removeConfirm: "هل تريد إزالة هذا العنصر من وسائط Mioseg QR؟",
    ...
    analyticsText: "مشاهدات وفتح وتنزيل وسائط Mioseg QR. صور المعاينة التي تُحمّل تلقائيًا لا تُحسب كمشاهدات صور.",
    ...
    gallery: "المعرض",
    galleryText: "هذه الصور مرتبطة حاليًا بـ Mioseg QR الخاص بك.",
    entries: "{{count}} عناصر",
    noGallery: "لا توجد صور في المعرض بعد.",
    files: "الملفات",
    filesText: "هذه الملفات مرتبطة حاليًا بـ Mioseg QR الخاص بك.",
  ...
  fr: {
    ...
    mediaTitle: "Médias Mioseg QR",
    missingId: "ID Mioseg QR manquant.",
    login: "Connectez-vous d’abord.",
    notFound: "Mioseg QR introuvable.",
    forbidden: "Vous ne pouvez pas modifier ce Mioseg QR.",
    analyticsLoadFailed: "Les statistiques des médias n’ont pas pu être chargées.",
    removeConfirm: "Retirer cet élément des médias Mioseg QR ?",
    ...
    analyticsText: "Vues, ouvertures et téléchargements de vos médias Mioseg QR. Les aperçus chargés automatiquement ne comptent pas comme vues.",
    ...
    gallery: "Galerie",
    galleryText: "Ces images sont actuellement liées à votre Mioseg QR.",
    entries: "{{count}} éléments",
    noGallery: "Aucune image dans la galerie.",
    files: "Fichiers",
    filesText: "Ces fichiers sont actuellement liés à votre Mioseg QR.",
  ...
  es: {
    ...
    mediaTitle: "Medios de Mioseg QR",
    missingId: "Falta el ID de Mioseg QR.",
    login: "Inicia sesión primero.",
    notFound: "No se encontró el Mioseg QR.",
    forbidden: "No puedes editar este Mioseg QR.",
    analyticsLoadFailed: "No se pudieron cargar las analíticas de medios.",
    removeConfirm: "¿Quitar este elemento de los medios de Mioseg QR?",
    ...
    analyticsText: "Vistas, aperturas y descargas de tus medios Mioseg QR. Las miniaturas cargadas automáticamente no cuentan como vistas de imagen.",
    ...
    gallery: "Galería",
    galleryText: "Estas imágenes están vinculadas actualmente a tu Mioseg QR.",
    entries: "{{count}} elementos",
    noGallery: "Todavía no hay imágenes en la galería.",
    files: "Archivos",
    filesText: "Estos archivos están vinculados actualmente a tu Mioseg QR.",
  ...
  it: {
    ...
    mediaTitle: "Media Mioseg QR",
    missingId: "ID Mioseg QR mancante.",
    login: "Accedi prima.",
    notFound: "Mioseg QR non trovato.",
    forbidden: "Non puoi modificare questo Mioseg QR.",
    analyticsLoadFailed: "Impossibile caricare le analytics dei media.",
    removeConfirm: "Rimuovere questo elemento dai media Mioseg QR?",
    ...
    analyticsText: "Visualizzazioni, aperture e download dei media Mioseg QR. Le anteprime caricate automaticamente non vengono conteggiate come visualizzazioni.",
    ...
    gallery: "Galleria",
    galleryText: "Queste immagini sono attualmente collegate al tuo Mioseg QR.",
    entries: "{{count}} elementi",
    noGallery: "Nessuna immagine in galleria.",
    files: "File",
    filesText: "Questi file sono attualmente collegati al tuo Mioseg QR.",
    noFiles: "Nessun file.",
