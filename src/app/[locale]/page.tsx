            ...
            <div className="landingBDemoColumns">
              <div className="landingBDemoColumn landingBDemoColumnBusiness">
                ...
                <div className="landingBDemoCards">
                  <article><span className="landingBDemoIcon">🏭</span><div><small>Maschine & Industrie</small><h4>MX-500</h4><p>Betriebsanleitung, technische Daten, Wartung, Prüfberichte und aktuelle Änderungen direkt an der Maschine.</p><span className="landingBDemoStatus">Demo QR-X vorbereitet</span></div></article>
                  <article><span className="landingBDemoIcon">🌡️</span><div><small>Produkt</small><h4>AeroTherm X12</h4><p>Der Hersteller verbindet Produktdaten, Dokumente, Support und spätere Aktualisierungen dauerhaft mit der Wärmepumpe.</p><span className="landingBDemoStatus">Demo QR-X vorbereitet</span></div></article>
                  <article><span className="landingBDemoIcon">🏠</span><div><small>Immobilie</small><h4>WohnOase</h4><p>Exposé, Bilder, Grundrisse, Standort und Kontakt bleiben über denselben QR-X erreichbar und aktualisierbar.</p><span className="landingBDemoStatus">Demo QR-X vorbereitet</span></div></article>
                  <article className="landingBDemoFeatured"><span className="landingBDemoIcon">🎭</span><div><small>Business QR-X + Collection</small><h4>Theater am Rhein</h4><p>Ein Theater-QR-X bündelt die Spielzeit. Die einzelnen Produktionen bleiben eigenständige QR-X innerhalb der Collection.</p><span className="landingBDemoStatus">Collection-Demo vorbereitet</span></div></article>
                </div>
              </div>
              ...
              <div className="landingBDemoColumn landingBDemoColumnPrivate">
                ...
                <div className="landingBPrivateExamples">
                  <article><span className="landingBDemoIcon">🌡️</span><div><small>Produkt im Alltag</small><h4>Deine AeroTherm X12</h4><p>QR-X an der Wärmepumpe scannen, speichern und Handbuch, Produktinformationen und spätere Hersteller-Updates wiederfinden.</p></div></article>
                  <article><span className="landingBDemoIcon">🔐</span><div><small>Privater QR-X</small><h4>Mein Zuhause</h4><p>Grundrisse, Energieausweis, Wartungsunterlagen und Hausinformationen in einem passwortgeschützten QR-X bündeln.</p><span className="landingBDemoPassword">Passwortschutz demonstrierbar</span></div></article>
                </div>
