...
const HOME_HERO_COPY: Record<PublicLocale, {
  ...
  de: { headline1:"Mehr als", headline2:"ein QR-Code.", headline3:"Mit Mioseg qr.", text:"Für dich: scannen, speichern, wiederfinden, folgen und entdecken. Für Unternehmen: Produkte, Maschinen, Projekte und Standorte dauerhaft mit aktuellen Informationen verbinden.", ctaExplore:"Explore entdecken", navFeatures:"Dynamische QR-Codes", navExplore:"Explore", navUseCases:"Für Unternehmen", navPrices:"Preise", miniScan:"Für dich", miniScanText:"Scannen, speichern, wiederfinden", miniSave:"Bleib aktuell", miniSaveText:"Folgen & Updates erhalten", miniExplore:"Für Unternehmen", miniExploreText:"Dynamische QR-Codes mit Mioseg qr" },
...
export default async function Home({ params }: Props) {
  ...
  const masterCopy = publicLanguage === "de" ? {
    learnMore:"Dynamische QR-Codes verstehen",
          ...
          <section id="qrx-explained" className="landingBQrxAha">
            ...
            <div className="landingBCompare">
              ...
              <div className="landingBCompareNew">
                <div className="landingBCompareNewHead"><span>Dynamischer QR-Code</span><strong>QR</strong></div>
