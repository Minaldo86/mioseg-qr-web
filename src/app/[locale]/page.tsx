...
export default async function Home({ params }: Props) {
  ...
  return (
    <main className={`${styles.page} landingBPage`} style={{ background: "#06101f", minHeight: "100vh" }}>
      ...
      {isGerman && (
        <>
          <section className="landingBDemoWorlds" aria-labelledby="demo-worlds-title">
            <div className="landingBSectionHeader">
              <span className="landingBEyebrow">QR-X in der Praxis</span>
              <h2 id="demo-worlds-title">Für Unternehmen. Für dich. Eine Verbindung.</h2>
              <p>Unternehmen stellen Informationen über QR-X bereit und halten sie aktuell. Nutzer scannen, speichern, organisieren und bleiben mit genau diesen Informationen verbunden.</p>
            </div>

            <div className="landingBDemoBridge">
              <div><span className="landingBAudienceBadge">Unternehmen</span><strong>QR-X erstellen & aktualisieren</strong><small>Informationen dauerhaft am Produkt, Objekt oder Ort bereitstellen.</small></div>
              <b>→</b>
              <div className="landingBDemoBridgeCore"><span>QR-X</span><strong>Eine dauerhafte Verbindung</strong><small>Der Code bleibt. Die Informationen können sich weiterentwickeln.</small></div>
              <b>→</b>
              <div><span className="landingBAudienceBadge">Für dich</span><strong>Scannen, speichern & folgen</strong><small>Später wiederfinden und über wichtige Änderungen informiert bleiben.</small></div>
            </div>

            <div className="landingBDemoColumns">
              <div className="landingBDemoColumn landingBDemoColumnBusiness">
                <div className="landingBDemoColumnHead"><span className="landingBAudienceBadge">Für Unternehmen</span><h3>So kann dein QR-X eingesetzt werden.</h3><p>Konkrete Beispiele zeigen, wie aus einem QR-Code ein dauerhaft verwaltbarer Informationspunkt wird.</p></div>
                <div className="landingBDemoCards">
                  <article><span className="landingBDemoIcon">🏭</span><div><small>Maschine & Industrie</small><h4>MX-500</h4><p>Betriebsanleitung, technische Daten, Wartung, Prüfberichte und aktuelle Änderungen direkt an der Maschine.</p><a className="landingBDemoLink" href="https://www.mioseg-qr.com/qrx/17be4d84-a874-433f-a0c0-3cf32a9021c1?lang=de" target="_blank" rel="noreferrer">Live-Demo öffnen →</a></div></article>
                  <article><span className="landingBDemoIcon">🌡️</span><div><small>Produkt</small><h4>AeroTherm X12</h4><p>Der Hersteller verbindet Produktdaten, Dokumente, Support und spätere Aktualisierungen dauerhaft mit der Wärmepumpe.</p><a className="landingBDemoLink" href="https://www.mioseg-qr.com/qrx/1f495090-4690-4d57-9081-cf21f09f7616" target="_blank" rel="noreferrer">Live-Demo öffnen →</a></div></article>
                  <article><span className="landingBDemoIcon">🏠</span><div><small>Immobilie</small><h4>WohnOase</h4><p>Exposé, Bilder, Grundrisse, Standort und Kontakt bleiben über denselben QR-X erreichbar und aktualisierbar.</p><a className="landingBDemoLink" href="https://www.mioseg-qr.com/qrx/2f8a5f04-db67-4fc1-b80b-67a2c049140d" target="_blank" rel="noreferrer">Live-Demo öffnen →</a></div></article>
                  <article className="landingBDemoFeatured"><span className="landingBDemoIcon">🎭</span><div><small>Business QR-X + Collection</small><h4>Theater am Rhein</h4><p>Ein Theater-QR-X bündelt die Spielzeit. Die einzelnen Produktionen bleiben eigenständige QR-X innerhalb der Collection.</p><a className="landingBDemoLink" href="https://www.mioseg-qr.com/qrx/4a44cab9-fcd6-4809-8dab-0301af443b0d" target="_blank" rel="noreferrer">Collection live öffnen →</a></div></article>
                </div>
              </div>

              <div className="landingBDemoColumn landingBDemoColumnPrivate">
                <div className="landingBDemoColumnHead"><span className="landingBAudienceBadge">Für dich</span><h3>Scannen ist erst der Anfang.</h3><p>Die App macht aus einzelnen Scans eine persönliche, organisierte QR-X Sammlung.</p></div>
                <div className="landingBPrivateBenefits">
                  <div><span>🔔</span><strong>Benachrichtigungen</strong><p>Wichtige Änderungen an gefolgten QR-X direkt mitbekommen.</p></div>
                  <div><span>📁</span><strong>Eigene Ordner</strong><p>Scans und QR-X nach deinen Themen übersichtlich organisieren.</p></div>
                  <div><span>▣</span><strong>Wiederfinden</strong><p>Gespeicherte QR-X später öffnen, ohne den Code erneut suchen zu müssen.</p></div>
                  <div><span>📍</span><strong>Karte</strong><p>Standortbezogene QR-X entdecken und gespeicherte Orte wiederfinden.</p></div>
                </div>
                <div className="landingBPrivateExamples">
                  <article><span className="landingBDemoIcon">🌡️</span><div><small>Produkt im Alltag</small><h4>Deine AeroTherm X12</h4><p>QR-X an der Wärmepumpe scannen, speichern und Handbuch, Produktinformationen und spätere Hersteller-Updates wiederfinden.</p><a className="landingBDemoLink" href="https://www.mioseg-qr.com/qrx/1f495090-4690-4d57-9081-cf21f09f7616" target="_blank" rel="noreferrer">Live-Demo öffnen →</a><span className="landingBDemoPassword">Demo-Passwort: mioseg-qr</span></div></article>
                  <article><span className="landingBDemoIcon">🔐</span><div><small>Privater QR-X</small><h4>Mein Zuhause</h4><p>Grundrisse, Energieausweis, Wartungsunterlagen und Hausinformationen in einem passwortgeschützten QR-X bündeln.</p><a className="landingBDemoLink" href="https://www.mioseg-qr.com/qrx/2b87342e-809b-46ad-9ba1-4b7bcd5a3d67" target="_blank" rel="noreferrer">Geschützte Demo öffnen →</a><span className="landingBDemoPassword">Demo-Passwort: mioseg-qr</span></div></article>
                </div>
                <div className="landingBNoAppLock"><strong>Ohne App sofort öffnen. Mit App mehr daraus machen.</strong><span>QR-X funktionieren weiterhin direkt im Web. Die App ergänzt Speichern, Ordner, Folgen, Benachrichtigungen und Karte.</span></div>
              </div>
            </div>
          </section>
        </>
