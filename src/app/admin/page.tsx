  ...
  const renderStorageAndMediaDashboard = () => (
    <section style={styles.storageDashboard} aria-label="Storage and Media Dashboard">
      ...
      {mediaDashboardSection === "storage" ? (
        <AdminMediaStorage
          styles={styles}
          storageMediaStats={storageMediaStats}
          storageMediaLoading={storageMediaLoading}
          storageMediaSearch={storageMediaSearch}
          setStorageMediaSearch={setStorageMediaSearch}
          storageMediaTypeFilter={storageMediaTypeFilter}
          setStorageMediaTypeFilter={setStorageMediaTypeFilter}
          storageMediaStatusFilter={storageMediaStatusFilter}
          setStorageMediaStatusFilter={setStorageMediaStatusFilter}
          storageMediaMinMb={storageMediaMinMb}
          setStorageMediaMinMb={setStorageMediaMinMb}
          storageMediaSort={storageMediaSort}
          setStorageMediaSort={setStorageMediaSort}
          fetchStorageMediaStats={fetchStorageMediaStats}
          renderStorageMediaTable={renderStorageMediaTable}
          renderStorageMediaDetailPanel={renderStorageMediaDetailPanel}
          formatStorageStatus={formatStorageStatus}
          formatNumber={formatNumber}
        />
      ) : null}
