...
import ExploreMapClient from "../[locale]/explore/ExploreMapClient";
...
export default async function ExplorePage({
  ...
  const { data, error } = await supabase
    .from("qr_x_entries")
    .select(
      "id, title, description, company_name, category, type, verified, cover_image_url, logo_url, location_name, location_lat, location_lng, created_at, suspended, deleted_at"
    )
    .eq("type", "business")
    .is("deleted_at", null)
