...
const PDF_COPY: Record<DocumentLanguage, PdfCopy> = {
  de: {
    ...
    invoicePosition: "Erwerb digitaler Nutzungscredits (Mioseg QR Credits)",
    creditPosition: "Gutschrift zur Rückerstattung digitaler Nutzungscredits (Mioseg QR Credits)",
  ...
  en: {
    ...
    invoicePosition: "Purchase of digital usage credits (Mioseg QR Credits)",
    creditPosition: "Credit for refunded digital usage credits (Mioseg QR Credits)",
  ...
  tr: {
    ...
    invoicePosition: "Dijital kullanım kredisi satın alımı (Mioseg QR Credits)",
    creditPosition: "İade edilen dijital kullanım kredileri için alacak (Mioseg QR Credits)",
  ...
  pl: {
    ...
    invoicePosition: "Zakup cyfrowych kredytów użytkowych (Mioseg QR Credits)",
    creditPosition: "Zwrot cyfrowych kredytów użytkowych (Mioseg QR Credits)",
  ...
  ar: {
    ...
    invoicePosition: "شراء أرصدة استخدام رقمية (Mioseg QR Credits)",
    creditPosition: "إشعار دائن لاسترداد أرصدة استخدام رقمية (Mioseg QR Credits)",
  ...
  fr: {
    ...
    invoicePosition: "Achat de crédits d’utilisation numériques (Mioseg QR Credits)",
    creditPosition: "Avoir pour remboursement de crédits d’utilisation numériques (Mioseg QR Credits)",
  ...
  es: {
    ...
    invoicePosition: "Compra de créditos de uso digitales (Mioseg QR Credits)",
    creditPosition: "Abono por reembolso de créditos de uso digitales (Mioseg QR Credits)",
  ...
  it: {
    ...
    invoicePosition: "Acquisto di crediti di utilizzo digitali (Mioseg QR Credits)",
    creditPosition: "Nota di credito per rimborso di crediti di utilizzo digitali (Mioseg QR Credits)",
