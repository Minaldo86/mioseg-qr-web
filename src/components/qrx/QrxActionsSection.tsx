...
export default function QrxActionsSection({
  ...
  onCopyLink,
  labels = {
    aria: "Mioseg QR Aktionen",
    own: "Eigener Mioseg QR",
    followed: "Gefolgt",
    follow: "Folgen",
    ownHint: "Du bist der Besitzer dieses Mioseg QR. Er ist automatisch in deinen erstellten Mioseg QR sichtbar.",
    savedHint: "Dieser Mioseg QR ist aktuell in deinen gespeicherten Einträgen.",
    followHint: "Du kannst diesem Mioseg QR folgen, um ihn in deiner App und im Web wiederzufinden.",
    loginHint: "Melde dich an, um diesem Mioseg QR zu folgen.",
    wait: "Bitte warten …",
    savedBy: "Gespeichert von {{count}}",
    image: "Mioseg QR Bild",
